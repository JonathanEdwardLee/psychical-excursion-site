...
`,Wn="Recognize the Dream: Lucid Dreaming, Reality Checks and Dream Signs",Pi="/lucid-dreaming-reality-checks/",vt=Pi,Wi="PEX-IMPLEMENTATION-PLACEHOLDER";let sn=null;function Li(){const n=Ma.trim();return!n||n.includes(Wi)?!1:n.startsWith(`# ${Wn}`)}function Bi(){if(!Li())throw new Error("Chapter 3 manuscript has not been supplied by PEX_PRIMARY");return sn||(sn=S(Ma)),sn}const Fi=`# Feel the Body: Body Scan Meditation and Deep Relaxation
...
`,Wt="Feel the Shift: Vibrations, Floating and Out-of-Body Sensations Near Sleep",ro="/out-of-body-sensations-sleep/",Lt=ro;let gn=null;function so(){return gn||(gn=S(oo)),gn}const lo=`# Know the Threshold: How to Recognize When Waking Imagery Becomes a Dream
...
`,Zt="Notice the Coincidence: Synchronicity, Recurring Dreams, Shared Dreams and Pattern Recognition",Po="/synchronicity-recurring-shared-dreams/",ea=Po;let xn=null;function Wo(){return xn||(xn=S(Oo)),xn}const Lo=`# Return. Record. Repeat: The Best Bedtime Routine for Lucid Dreaming and Astral Projection
