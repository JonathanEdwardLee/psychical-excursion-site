...
`,Ka=`# Remember Your Dreams: Dream Recall Techniques and Research
...
`,ut="Notice Your Dreams: Dream Awareness, Patterns and Dream Signs",bi="/dream-awareness-signs/",mt=bi;let an=null;function wi(){return an||(an=M(fi)),an}const fa=`# Recognize the Dream: Lucid Dreaming, Reality Checks and Dream Signs
...
`,Nn="Recognize the Dream: Lucid Dreaming, Reality Checks and Dream Signs",vi="/lucid-dreaming-reality-checks/",pt=vi,Ti="PEX-IMPLEMENTATION-PLACEHOLDER";let on=null;function ki(){const n=fa.trim();return!n||n.includes(Ti)?!1:n.startsWith(`# ${Nn}`)}function Ii(){if(!ki())throw new Error("Chapter 3 manuscript has not been supplied by PEX_PRIMARY");return on||(on=M(fa)),on}const xi=`# Feel the Body: Body Scan Meditation and Deep Relaxation
...
`,gt="Feel the Body: Body Scan Meditation and Deep Relaxation",Ai="/body-scan-meditation/",yt=Ai;let rn=null;function Si(){return rn||(rn=M(xi)),rn}const Ei=`# Build the Current: Tingling, Energy Sensations and Focused Attention
...
`,ft="Build the Current: Tingling, Energy Sensations and Focused Attention",Ri="/energy-sensations-meditation/",bt=Ri;let sn=null;function Mi(){return sn||(sn=M(Ei)),sn}const Di=`# Quiet the Mind: Meditation Techniques for Sleep and Dream Awareness
...
`,wt="Quiet the Mind: Meditation Techniques for Sleep and Dream Awareness",Ci="/meditation-for-lucid-dreaming/",vt=Ci;let ln=null;function Ni(){return ln||(ln=M(Di)),ln}const Oi=`# See the Image: Visualization, Mental Imagery and Hypnagogic Imagery
...
`,Tt="See the Image: Visualization, Mental Imagery and Hypnagogic Imagery",Pi="/visualization-hypnagogic-imagery/",kt=Pi;let hn=null;function Wi(){return hn||(hn=M(Oi)),hn}const Li=`# Watch the Edge: Hypnagogia and the Transition Into Lucid Dreaming
...
`,It="Watch the Edge: Hypnagogia and the Transition Into Lucid Dreaming",Fi="/hypnagogia-lucid-dreaming/",xt=Fi;let cn=null;function Bi(){return cn||(cn=M(Li)),cn}const Hi=`# Let the Body Sleep: The “Mind Awake, Body Asleep” Route to Lucid Dreaming
...
`,At="Let the Body Sleep: The “Mind Awake, Body Asleep” Route to Lucid Dreaming",zi="/mind-awake-body-asleep/",St=zi;let dn=null;function Yi(){return dn||(dn=M(Hi)),dn}const qi=`# Move Without Moving: Motor Imagery, Dream Movement and Sleep-Onset Practice
...
`,Et="Move Without Moving: Motor Imagery, Dream Movement and Sleep-Onset Practice",ji="/motor-imagery-lucid-dreaming/",Rt=ji;let un=null;function _i(){return un||(un=M(qi)),un}const Gi=`# Feel the Shift: Vibrations, Floating and Out-of-Body Sensations Near Sleep
...
`,Mt="Feel the Shift: Vibrations, Floating and Out-of-Body Sensations Near Sleep",Vi="/out-of-body-sensations-sleep/",Dt=Vi;let mn=null;function Ui(){return mn||(mn=M(Gi)),mn}const Ji=`# Know the Threshold: How to Recognize When Waking Imagery Becomes a Dream
...
`,Ct="Know the Threshold: How to Recognize When Waking Imagery Becomes a Dream",$i="/entering-a-lucid-dream/",Nt=$i;let pn=null;function Ki(){return pn||(pn=M(Ji)),pn}const Qi=`# Stabilize the Dream: Lucid Dream Stabilization Techniques and Research
...
`,Ot="Stabilize the Dream: Lucid Dream Stabilization Techniques and Research",Xi="/lucid-dream-stabilization/",Pt=Xi;let gn=null;function Zi(){return gn||(gn=M(Qi)),gn}const eo=`# Explore the Dream: Lucid Dream Experiments, Dream Control and Research
...
`,Wt="Explore the Dream: Lucid Dream Experiments, Dream Control and Research",no="/lucid-dream-experiments/",Lt=no;let yn=null;function to(){return yn||(yn=M(eo)),yn}const ao=`# Loosen the Body: Body Ownership, Self-Location and Out-of-Body Experience
...
`,Ft="Loosen the Body: Body Ownership, Self-Location and Out-of-Body Experience",io="/out-of-body-experience-body-ownership/",Bt=io;let fn=null;function oo(){return fn||(fn=M(ao)),fn}const ro=`# Cross the Threshold: Astral Projection, OBE Techniques and Lucid Dreaming
...
`,Ht="Cross the Threshold: Astral Projection, OBE Techniques and Lucid Dreaming",so="/astral-projection-obe-techniques/",zt=so;let bn=null;function lo(){return bn||(bn=M(ro)),bn}const ho=`# Test the Experience: Can Lucid Dreams and Out-of-Body Experiences Be Verified?
...
`,Yt="Test the Experience: Can Lucid Dreams and Out-of-Body Experiences Be Verified?",co="/testing-out-of-body-experiences/",qt=co;let wn=null;function uo(){return wn||(wn=M(ho)),wn}const mo=`# Compare the Maps: Lucid Dreaming vs. Astral Projection, OBE and Sleep Paralysis
...
`,jt="Compare the Maps: Lucid Dreaming vs. Astral Projection, OBE and Sleep Paralysis",po="/lucid-dreaming-vs-astral-projection/",_t=po;let vn=null;function go(){return vn||(vn=M(mo)),vn}const yo=`# Watch the Sky: Sun, Moon, Planets and the Science of Sleep & Dreams
...
`,Fr="An experiment in dreams, consciousness, energy, and out-of-body experience";function Br(n){const e=n.trim(),t=e.match(/^#\s+(.+)\n+/);if(!t)throw new Error("Guidebook manuscript must begin with a top-level heading");const a=t[1].trim(),o=e.slice(t[0].length).split(/\n## /),r=aa(o[0]??""),s=[];let l=[];for(let h=1;h<o.length;h+=1){const d=o[h],c=d.indexOf(`
`),g=(c===-1?d:d.slice(0,c)).trim(),b=c===-1?"":d.slice(c+1);if(g==="References"){l=Hr(b);continue}s.push({heading:g,paragraphs:aa(b)})}return{openingHeading:a,openingParagraphs:r,sections:s,references:l}}function aa(n){return n.split(/\n---\n/).flatMap(e=>e.split(/\n\n+/)).map(e=>e.replace(/\n/g," ").trim()).filter(Boolean)}function Hr(n){return n.split(/\n+/).map(e=>e.trim()).filter(Boolean)}let An=null;function zr(){return An||(An=Br(Lr)),An}function ia(n){return n.replace(/[.,;:!?)]+$/u,"")}function qe(n,e={}){const{linkCitations:t=!0}=e,a=m("span",{class:"guidebook-rich-text"}),i=t?/(\[[^\]]+\]\((?:pex:[a-z0-9-]+|#\/[^)\s]+)\)|\*\*[^*]+\*\*|\*[^*]+\*|\[\d+\]|https:\/\/\S+|doi:10\.\S+)/gi:/(\[[^\]]+\]\((?:pex:[a-z0-9-]+|#\/[^)\s]+)\)|\*\*[^*]+\*\*|\*[^*]+\*|https:\/\/\S+|doi:10\.\S+)/gi;let o=0;for(const r of n.matchAll(i)){const s=r.index??0;s>o&&a.append(n.slice(o,s));const l=r[0],h=l.match(/^\[([^\]]+)\]\((pex:[a-z0-9-]+|#\/[^)\s]+)\)$/i);if(h){const d=h[1],c=h[2],g=c.toLowerCase().startsWith("pex:")?c.slice(4).toLowerCase():"",b=g?ni[g]:void 0,f=b?.href??(c===Rn||c.endsWith(`#${Kn}`)?Rn:c),T=m("a",{href:f,class:"guidebook-pex-link","data-pex-link":b?.id??En}),C=d.match(/^\*\*(.+)\*\*$/);C?T.append(m("strong",{},[C[1]])):T.append(d),a.append(T)}else if(l.startsWith("**"))a.append(m("strong",{},[l.slice(2,-2)]));else if(l.startsWith("*"))a.append(m("em",{},[l.slice(1,-1)]));else if(/^\[\d+\]$/.test(l)&&t){const d=l.slice(1,-1);a.append(m("a",{href:`#ref-${d}`,class:"guidebook-citation"},[l]))}else if(l.toLowerCase().startsWith("doi:10.")){const d=ia(l.slice(4));a.append(m("a",{href:`https://doi.org/${d}`,class:"guidebook-doi",rel:"noreferrer"},[l]))}else if(l.toLowerCase().startsWith("https://")){const d=ia(l);a.append(m("a",{href:d,class:"guidebook-external",rel:"noreferrer"},[l]))}else a.append(l);o=s+l.length}return o<n.length&&a.append(n.slice(o)),a.childNodes.length||a.append(n),a}function Vn(n,e){const t=m("p",{});return t.append(qe(n,e)),t}function Ha(n){const e=n.match(/^(?:\*\*)?\[(\d+)\](?:\*\*)?\s*(.*)$/),t=e?.[1]??"0",a=e?.[2]??n,i=m("li",{id:`ref-${t}`,class:"guidebook-reference-item"}),o=m("span",{class:"guidebook-ref-num"},[`[${t}] `]);return i.append(o,qe(a,{linkCitations:!1})),i.tabIndex=-1,i}function Yr(n){for(const e of n.querySelectorAll("a.guidebook-citation"))e.addEventListener("click",t=>{const i=(e.getAttribute("href")??"").match(/^#ref-(\d+)$/);if(!i)return;const o=n.querySelector(`#ref-${i[1]}`);if(!o)return;t.preventDefault();const r=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;o.scrollIntoView({behavior:r?"auto":"smooth",block:"start"}),o.focus({preventScroll:!0})});for(const e of n.querySelectorAll("a.guidebook-pex-link"))e.addEventListener("click",t=>{const a=e.getAttribute("href")??"";let i="",o=!0;try{const l=new URL(a,window.location.href);i=l.hash.replace(/^#/,"");const h=window.location.pathname.replace(/\/?$/,"/"),d=l.pathname.replace(/\/?$/,"/");o=d===h||d==="/"||a.startsWith("#")}catch{i=a.includes("#")?a.split("#").pop()??"":""}if(!i||i.startsWith("/")||!o)return;const r=n.querySelector(`[id="${i}"]`);if(!r)return;t.preventDefault(),r.closest(".guidebook-section")?.classList.add("is-visible");const s=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;r.scrollIntoView({behavior:s?"auto":"smooth",block:"start"}),r.focus({preventScroll:!0})})}function Pe(n){return m("section",{class:n?"guidebook-section pex-reveal is-visible":"guidebook-section pex-reveal"})}function qr(n){const e=zr(),t=m("article",{class:"guidebook-article"});let a=Pe(!0);t.append(a),a.append(m("p",{class:"guidebook-subtitle"},[Fr]),m("h1",{class:"guidebook-opening-title"},[di]),m("p",{class:"guidebook-opening-heading"},[e.openingHeading]),...e.openingParagraphs.map(i=>Vn(i)));for(const i of e.sections){a=Pe(!1),t.append(a),a.append(m("h2",{class:"guidebook-section-title"},[i.heading]));for(const o of i.paragraphs){if(o.startsWith("**")&&o.endsWith("**")){a.append(m("p",{class:"guidebook-emphasis-line"},[o.slice(2,-2)]));continue}a.append(Vn(o))}}if(e.references.length){a=Pe(!1),t.append(a),a.append(m("h2",{class:"guidebook-section-title",id:"references"},["References"]));const i=m("ul",{class:"guidebook-references"});for(const o of e.references)i.append(Ha(o));a.append(i)}a=Pe(!1),t.append(a),a.append(m("p",{class:"guidebook-next"},[m("a",{href:ma,class:"guidebook-next-link",id:"guidebook-next-chapter"},[ua,m("span",{class:"guidebook-next-arrow","aria-hidden":"true"},[" →"])])])),n.append(t)}const We={innerSeconds:180,midSeconds:240,outerSeconds:300,breatheSeconds:96},_=500,G=500;function v(n,e={}){const t=document.createElementNS("http://www.w3.org/2000/svg",n);for(const[a,i]of Object.entries(e))t.setAttribute(a,i);return t}function x(n,e){const t=(e-90)*Math.PI/180;return[_+n*Math.cos(t),G+n*Math.sin(t)]}function za(n,e,t=0){return Array.from({length:n},(a,i)=>x(e,360/n*i+t).join(",")).join(" ")}function oa(n,e,t,a=0){const i=[];for(let o=0;o<n;o+=1)i.push(x(e,360/n*o+a).join(",")),i.push(x(t,360/n*o+180/n+a).join(","));return i.join(" ")}function Sn(n,e,t,a){return[x(t,n),x((e+t)/2,n-a),x(e,n),x((e+t)/2,n+a)].map(i=>i.join(",")).join(" ")}function jr(n,e,t,a){return[x(t,n),x(e,n-a),x(e,n+a)].map(i=>i.join(",")).join(" ")}function j(n,e,t,a,i){n.append(v("polygon",{class:i,points:za(e,t,a)}))}function _r(){return typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Gr(){const n=_r(),e=m("figure",{class:n?"pex-attention-instrument is-static":"pex-attention-instrument"});e.setAttribute("role","img"),e.setAttribute("aria-label","Original Psychical Excursion attention instrument: nested thin-line geometry around a fixed center. Looking toward the center is optional. Seeing no afterimage or mental picture is not required.");const t=v("svg",{viewBox:"0 0 1000 1000",focusable:"false"});t.style.setProperty("--pex-attention-inner",`${We.innerSeconds}s`),t.style.setProperty("--pex-attention-mid",`${We.midSeconds}s`),t.style.setProperty("--pex-attention-outer",`${We.outerSeconds}s`),t.style.setProperty("--pex-attention-breathe",`${We.breatheSeconds}s`);const a=v("g",{class:"pex-attention-layer pex-attention-beyond"});a.append(v("polygon",{class:"pex-attention-line pex-attention-faintest",points:za(36,486,5)})),a.append(v("circle",{class:"pex-attention-line pex-attention-faintest",cx:String(_),cy:String(G),r:"478"}));for(let h=0;h<72;h+=1){const d=h*5,c=x(468,d),g=x(h%6===0?492:484,d);a.append(v("line",{class:"pex-attention-line pex-attention-faintest",x1:c[0].toFixed(2),y1:c[1].toFixed(2),x2:g[0].toFixed(2),y2:g[1].toFixed(2)}))}const i=v("g",{class:"pex-attention-layer pex-attention-spin-outer"});i.append(v("circle",{class:"pex-attention-line pex-attention-strong",cx:String(_),cy:String(G),r:"438"})),i.append(v("circle",{class:"pex-attention-line",cx:String(_),cy:String(G),r:"418"}));for(let h=0;h<144;h+=1){const d=h*2.5,c=h%12===0,g=h%4===0,b=x(c?398:g?406:410,d),f=x(438,d);i.append(v("line",{class:c?"pex-attention-line pex-attention-strong":"pex-attention-line pex-attention-fine",x1:b[0].toFixed(2),y1:b[1].toFixed(2),x2:f[0].toFixed(2),y2:f[1].toFixed(2)}))}for(let h=0;h<8;h+=1){const d=h*45;i.append(v("polygon",{class:"pex-attention-line",points:Sn(d,442,462,3.2)}));const c=x(h%2===0?454:448,d);i.append(v("circle",{class:"pex-attention-fill pex-attention-fine",cx:c[0].toFixed(2),cy:c[1].toFixed(2),r:h%2===0?"2.1":"1.3"}))}for(const h of[18,138,258])i.append(v("path",{class:"pex-attention-line pex-attention-arc",d:Vr(394,h,h+84)}));const o=v("g",{class:"pex-attention-layer pex-attention-spin-mid"});for(const h of[372,344,316,288])o.append(v("circle",{class:"pex-attention-line",cx:String(_),cy:String(G),r:String(h)}));j(o,12,372,0,"pex-attention-line pex-attention-soft"),j(o,12,372,15,"pex-attention-line pex-attention-soft");for(let h=0;h<24;h+=1)o.append(v("polygon",{class:"pex-attention-line",points:Sn(h*15,300,368,5.4)}));for(let h=0;h<36;h+=1)o.append(v("polygon",{class:"pex-attention-line pex-attention-fine",points:jr(h*10,248,286,3.6)}));for(let h=0;h<24;h+=1){const d=h*15,c=x(132,d),g=x(h%2===0?368:316,d);o.append(v("line",{class:h%2===0?"pex-attention-line":"pex-attention-line pex-attention-fine",x1:c[0].toFixed(2),y1:c[1].toFixed(2),x2:g[0].toFixed(2),y2:g[1].toFixed(2)}))}const r=v("g",{class:"pex-attention-layer pex-attention-breathe"});j(r,8,236,0,"pex-attention-line pex-attention-strong"),j(r,8,236,22.5,"pex-attention-line"),j(r,6,204,0,"pex-attention-line"),j(r,6,204,30,"pex-attention-line"),j(r,4,176,0,"pex-attention-line pex-attention-soft"),j(r,4,176,45,"pex-attention-line pex-attention-soft"),r.append(v("polygon",{class:"pex-attention-line",points:oa(16,220,148,0)})),r.append(v("polygon",{class:"pex-attention-line pex-attention-fine",points:oa(12,190,126,15)}));for(const h of[168,148,128])r.append(v("circle",{class:"pex-attention-line pex-attention-fine",cx:String(_),cy:String(G),r:String(h)}));const s=v("g",{class:"pex-attention-layer pex-attention-spin-inner"});for(let h=0;h<12;h+=1){const[d,c]=x(34,h*30);s.append(v("circle",{class:"pex-attention-line",cx:d.toFixed(2),cy:c.toFixed(2),r:"34"}))}for(let h=0;h<8;h+=1)s.append(v("polygon",{class:"pex-attention-line pex-attention-fine",points:Sn(h*45+22.5,58,108,8)}));j(s,16,96,0,"pex-attention-line pex-attention-fine"),j(s,8,72,0,"pex-attention-line"),s.append(v("circle",{class:"pex-attention-line",cx:String(_),cy:String(G),r:"54"}));for(let h=0;h<32;h+=1){const d=h*11.25,c=x(46,d),g=x(h%4===0?70:62,d);s.append(v("line",{class:"pex-attention-line pex-attention-fine",x1:c[0].toFixed(2),y1:c[1].toFixed(2),x2:g[0].toFixed(2),y2:g[1].toFixed(2)}))}const l=v("g",{class:"pex-attention-layer pex-attention-center"});return l.append(v("circle",{class:"pex-attention-line pex-attention-strong",cx:String(_),cy:String(G),r:"18"})),l.append(v("circle",{class:"pex-attention-line pex-attention-fine",cx:String(_),cy:String(G),r:"8"})),l.append(v("circle",{class:"pex-attention-fill pex-attention-center-point",cx:String(_),cy:String(G),r:"2.2"})),t.append(a,i,o,r,s,l),e.append(t),e}function Vr(n,e,t){const a=x(n,e),i=x(n,t),o=t-e>180?1:0;return`M ${a[0].toFixed(2)} ${a[1].toFixed(2)} A ${n} ${n} 0 ${o} 1 ${i[0].toFixed(2)} ${i[1].toFixed(2)}`}function ue(n){return m("section",{class:n?"guidebook-section pex-reveal is-visible":"guidebook-section pex-reveal"})}function Ya(n,e,t="guidebook-section-subheading"){for(const a of e){if(a.kind==="emphasis"){n.append(m("p",{class:"guidebook-emphasis-line"},[a.text]));continue}if(a.kind==="quote"){const i=m("blockquote",{class:"guidebook-pull"});i.append(qe(a.text)),n.append(i);continue}if(a.kind==="list"){const i=m(a.ordered?"ol":"ul",{class:"guidebook-steps"});for(const o of a.items){const r=m("li",{});r.append(qe(o)),i.append(r)}n.append(i);continue}if(a.kind==="rule"){n.append(m("hr",{class:"guidebook-rule"}));continue}if(!(a.kind==="heading"||a.kind==="practice"||a.kind==="attention")){if(a.kind==="subheading"){n.append(m("h3",{class:t},[a.text]));continue}n.append(Vn(a.text))}}}function Ur(n){const e=m("section",{class:"guidebook-practice-part"});return e.append(m("h2",{class:"guidebook-practice-label"},[n.label])),Ya(e,n.blocks,"guidebook-practice-subheading"),e}function Jr(n){return m("nav",{class:"guidebook-prev","aria-label":"Previous reading"},[m("a",{href:n.href,class:"guidebook-prev-link",id:n.id},[m("span",{class:"guidebook-prev-arrow","aria-hidden":"true"},["← "]),n.title])])}function E(n,e,t={}){const a=m("article",{class:"guidebook-article guidebook-chapter"});let i=ue(!0);a.append(i),t.previous&&i.append(Jr(t.previous)),i.append(m("h1",{class:"guidebook-chapter-title"},[e.title]));for(const o of e.blocks){if(o.kind==="heading"){i=ue(!1),a.append(i);const r=m("h2",{class:"guidebook-section-title"},[o.text]),s=ei(o.text);s&&(r.id=s,r.tabIndex=-1),i.append(r);continue}if(o.kind==="practice"){i=ue(!1),a.append(i);const r=m("aside",{class:"guidebook-practice","aria-label":"Summary, experiment, and intention"});for(const s of o.parts)r.append(Ur(s));i.append(r);continue}if(o.kind==="attention"){i=ue(!1),a.append(i),i.append(Gr());continue}Ya(i,[o])}if(e.references.length){i=ue(!1),a.append(i),i.append(m("h2",{class:"guidebook-section-title",id:"references"},["References"]));const o=m("ul",{class:"guidebook-references"});for(const r of e.references)o.append(Ha(r));i.append(o)}t.next&&(i=ue(!1),a.append(i),i.append(m("p",{class:"guidebook-next"},[m("a",{href:t.next.href,class:"guidebook-next-link",id:t.next.id},[t.next.title,m("span",{class:"guidebook-next-arrow","aria-hidden":"true"},[" →"])])]))),n.append(a)}function I(n,e){const t=document.createElementNS("http://www.w3.org/2000/svg",n);for(const[a,i]of Object.entries(e))t.setAttribute(a,i);return t}function $r(n){const e=m("div",{class:`pex-ambient pex-ambient-${n}`,"aria-hidden":"true"}),t=I("svg",{viewBox:"0 0 1200 900",focusable:"false"}),a=I("g",{class:"pex-ambient-spin pex-ambient-spin-slow"});a.append(I("circle",{class:"pex-ambient-arc",cx:"620",cy:"430",r:"318"}),I("circle",{class:"pex-ambient-arc pex-ambient-arc-faint",cx:"620",cy:"430",r:"214"}),I("circle",{class:"pex-ambient-point",cx:"938",cy:"430",r:"2.2"}),I("circle",{class:"pex-ambient-point",cx:"406",cy:"238",r:"1.6"}));const i=I("g",{class:"pex-ambient-spin pex-ambient-spin-mid"});i.append(I("ellipse",{class:"pex-ambient-arc",cx:"580",cy:"400",rx:"430",ry:"168"}),I("path",{class:"pex-ambient-arc pex-ambient-arc-partial",d:"M220 520 C 380 220, 820 180, 1040 470"}),I("circle",{class:"pex-ambient-point",cx:"1010",cy:"400",r:"1.8"}));const o=I("g",{class:"pex-ambient-axis"});if(o.append(I("line",{class:"pex-ambient-line",x1:"600",y1:"40",x2:"600",y2:"860"}),I("line",{class:"pex-ambient-line pex-ambient-line-soft",x1:"80",y1:"390",x2:"1120",y2:"510"})),t.append(o,a,i),n==="memory"){const r=I("g",{class:"pex-ambient-memory-forms"});r.append(I("ellipse",{class:"pex-ambient-form pex-ambient-form-a",cx:"430",cy:"360",rx:"92",ry:"48"}),I("ellipse",{class:"pex-ambient-form pex-ambient-form-b",cx:"760",cy:"500",rx:"70",ry:"110"}),I("circle",{class:"pex-ambient-form pex-ambient-form-c",cx:"620",cy:"280",r:"36"})),t.append(r)}if(n==="notice"||n==="recognize"){const r=I("g",{class:"pex-ambient-notice-align"});r.append(I("path",{class:"pex-ambient-arc pex-ambient-align-a",d:"M260 300 C 480 220, 700 240, 940 360"}),I("path",{class:"pex-ambient-arc pex-ambient-align-b",d:"M300 620 C 520 420, 760 380, 980 520"}),I("circle",{class:"pex-ambient-point pex-ambient-align-point",cx:"640",cy:"390",r:"2.4"})),n==="recognize"&&r.append(I("circle",{class:"pex-ambient-form pex-ambient-recognize-ring",cx:"640",cy:"390",r:"5.5"})),t.append(r)}if(n==="body"){const r=I("g",{class:"pex-ambient-body-forms"});r.append(I("ellipse",{class:"pex-ambient-form pex-ambient-form-a",cx:"620",cy:"318",rx:"36",ry:"48"}),I("ellipse",{class:"pex-ambient-form pex-ambient-form-b",cx:"620",cy:"468",rx:"58",ry:"92"}),I("circle",{class:"pex-ambient-point",cx:"620",cy:"390",r:"1.8"})),t.append(r)}return e.append(t),e}const Kr=[{name:"Aries",glyph:"♈︎"},{name:"Taurus",glyph:"♉︎"},{name:"Gemini",glyph:"♊︎"},{name:"Cancer",glyph:"♋︎"},{name:"Leo",glyph:"♌︎"},{name:"Virgo",glyph:"♍︎"},{name:"Libra",glyph:"♎︎"},{name:"Scorpio",glyph:"♏︎"},{name:"Sagittarius",glyph:"♐︎"},{name:"Capricorn",glyph:"♑︎"},{name:"Aquarius",glyph:"♒︎"},{name:"Pisces",glyph:"♓︎"}];function ra(n){const e=(n%360+360)%360;return Kr[Math.floor(e/30)%12]}function Qr(n){const e=new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric"}).format(n),t=new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"2-digit"}).format(n),a=new Intl.DateTimeFormat(void 0,{month:"long",day:"numeric",hour:"numeric",minute:"2-digit"}).format(n);return{date:e,time:t,spoken:a}}function sa(n,e,t,a){const i=n==="sun"?`Sun in ${t}`:`Moon in ${t}`;return m("span",{class:"sky-widget-pair",tabindex:"0",role:"img","aria-label":i,"data-sky-body":n},[m("span",{class:"sky-widget-body","aria-hidden":"true"},[e]),m("span",{class:"sky-widget-sign","aria-hidden":"true"},[a]),m("span",{class:"sky-widget-tip","aria-hidden":"true"},[i])])}function Xr(){const n=new Date,e=Pr(n),t=ra(e.sun.eclipticLongitudeDeg),a=ra(e.moon.eclipticLongitudeDeg),i=Cr(n),o=i?Qr(i):null,r=o?`Sun in ${t.name}. Moon in ${a.name}. Next full moon ${o.spoken}.`:`Sun in ${t.name}. Moon in ${a.name}.`,s=o?m("span",{class:"sky-widget-full"},[m("span",{class:"sky-widget-full-label"},["Full Moon · "]),m("span",{class:"sky-widget-full-when"},[`${o.date} · ${o.time}`])]):m("span",{class:"sky-widget-full"},["Full Moon"]);return m("div",{class:"sky-widget-compact",role:"group","aria-label":r},[sa("sun",`${La}${ta}`,t.name,t.glyph),sa("moon",`${Fa}${ta}`,a.name,a.glyph),s])}function Zr(n){return n==="chapter01"?"memory":n==="chapter02"?"notice":n==="chapter03"?"recognize":n==="chapter04"?"body":"orbit"}function es(n){const e=pi(n);return e?gi(e.title):"Psychical Excursion"}function ns(n,e){$n(),document.title=es(e),n.replaceChildren();const t=m("a",{class:"skip-link",href:"#main"},["Skip to content"]),a=Zr(e),i=$r(a),o=as(),r=m("header",{class:"app-header guidebook-header"},[m("a",{href:te,class:"brand-link","aria-label":"Psychical Excursion home"},[m("img",{class:"brand-logo brand-logo-light",src:"/brand/pex-logo-primary.svg",alt:"",width:"220",height:"52",decoding:"async"}),m("img",{class:"brand-logo brand-logo-reverse",src:"/brand/pex-logo-primary-reverse.svg",alt:"",width:"220",height:"52",decoding:"async"})]),m("div",{class:"header-tools guidebook-tools"},[Xr(),m("span",{class:"guidebook-tools-rule","aria-hidden":"true"}),o])]),s=m("div",{id:"live-status",class:"visually-hidden","aria-live":"polite"}),l=m("main",{id:"main",class:"main-stage guidebook-main",tabindex:"-1","data-guidebook-page":e}),h=m("footer",{class:"site-footer guidebook-footer"},[m("p",{class:"attribution"},[Co("Website by "),m("a",{href:"https://hoopsnakedesigns.com/",rel:"noreferrer"},["Hoopsnake Designs"])])]),d=m("div",{class:"app-frame guidebook-frame","data-ambient":a},[r,s,l,h]);return n.append(t,i,d),{main:l}}function ts(n){Yr(n)}function as(){const n=Jn()==="bedtime",e=m("button",{type:"button",id:"theme-light-dark",class:"theme-switch",role:"switch",dir:"ltr","aria-checked":n?"true":"false","aria-label":"Dark appearance"},[m("span",{class:"theme-switch-track","aria-hidden":"true",dir:"ltr"},[m("span",{class:"theme-switch-thumb"})])]);return e.addEventListener("click",()=>{const a=$a()==="bedtime";e.setAttribute("aria-checked",a?"true":"false")}),e}const Un=[];function qa(){for(;Un.length;)Un.pop()?.()}function is(){return typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function os(n){qa();const e=[...n.querySelectorAll(".pex-reveal")];if(e.length===0)return;if(is()||typeof IntersectionObserver!="function"){for(const a of e)a.classList.add("is-visible");return}e[0]?.classList.add("is-visible");const t=new IntersectionObserver(a=>{for(const i of a)i.isIntersecting&&(i.target.classList.add("is-visible"),t.unobserve(i.target))},{threshold:.08,rootMargin:"0px 0px -10% 0px"});for(const a of e)t.observe(a);Un.push(()=>t.disconnect())}const la=[];function rs(){for(;la.length;)la.pop()?.()}async function ss(n){{if(ba())return;No(),Wr(),rs(),qa();const e=Io(),t=ko(),a=xo(e);a&&!t&&kn(),Ao(e);const{main:i}=ns(n,e),o={href:te,title:"Introduction",id:"guidebook-prev-home"};if(e==="chapter01"?E(i,ri(),{previous:o,next:{href:mt,title:ut,id:"guidebook-next-chapter-2"}}):e==="chapter02"?E(i,wi(),{previous:{href:ai,title:ua,id:"guidebook-prev-chapter-1"},next:{href:pt,title:Nn,id:"guidebook-next-chapter-3"}}):e==="chapter03"?E(i,Ii(),{previous:{href:mt,title:ut,id:"guidebook-prev-chapter-2"},next:{href:yt,title:gt,id:"guidebook-next-chapter-4"}}):e==="chapter04"?E(i,Si(),{previous:{href:pt,title:Nn,id:"guidebook-prev-chapter-3"},next:Le()?{href:dt,title:Cn,id:"guidebook-next-chapter-5"}:void 0}):e==="chapter05"&&Le()?E(i,hi(),{previous:{href:yt,title:gt,id:"guidebook-prev-chapter-4"},next:{href:bt,title:ft,id:"guidebook-next-chapter-6"}}):e==="chapter06"?E(i,Mi(),{previous:{href:dt,title:Cn,id:"guidebook-prev-chapter-5"},next:{href:vt,title:wt,id:"guidebook-next-chapter-7"}}):e==="chapter07"?E(i,Ni(),{previous:{href:bt,title:ft,id:"guidebook-prev-chapter-6"},next:{href:kt,title:Tt,id:"guidebook-next-chapter-8"}}):e==="chapter08"?E(i,Wi(),{previous:{href:vt,title:wt,id:"guidebook-prev-chapter-7"},next:{href:xt,title:It,id:"guidebook-next-chapter-9"}}):e==="chapter09"?E(i,Bi(),{previous:{href:kt,title:Tt,id:"guidebook-prev-chapter-8"},next:{href:St,title:At,id:"guidebook-next-chapter-10"}}):e==="chapter10"?E(i,Yi(),{previous:{href:xt,title:It,id:"guidebook-prev-chapter-9"},next:{href:Rt,title:Et,id:"guidebook-next-chapter-11"}}):e==="chapter11"?E(i,_i(),{previous:{href:St,title:At,id:"guidebook-prev-chapter-10"},next:{href:Dt,title:Mt,id:"guidebook-next-chapter-12"}}):e==="chapter12"?E(i,Ui(),{previous:{href:Rt,title:Et,id:"guidebook-prev-chapter-11"},next:{href:Nt,title:Ct,id:"guidebook-next-chapter-13"}}):e==="chapter13"?E(i,Ki(),{previous:{href:Dt,title:Mt,id:"guidebook-prev-chapter-12"},next:{href:Pt,title:Ot,id:"guidebook-next-chapter-14"}}):e==="chapter14"?E(i,Zi(),{previous:{href:Nt,title:Ct,id:"guidebook-prev-chapter-13"},next:{href:Lt,title:Wt,id:"guidebook-next-chapter-15"}}):e==="chapter15"?E(i,to(),{previous:{href:Pt,title:Ot,id:"guidebook-prev-chapter-14"},next:{href:Bt,title:Ft,id:"guidebook-next-chapter-16"}}):e==="chapter16"?E(i,oo(),{previous:{href:Lt,title:Wt,id:"guidebook-prev-chapter-15"},next:{href:zt,title:Ht,id:"guidebook-next-chapter-17"}}):e==="chapter17"?E(i,lo(),{previous:{href:Bt,title:Ft,id:"guidebook-prev-chapter-16"},next:{href:qt,title:Yt,id:"guidebook-next-chapter-18"}}):e==="chapter18"?E(i,uo(),{previous:{href:zt,title:Ht,id:"guidebook-prev-chapter-17"},next:{href:_t,title:jt,id:"guidebook-next-chapter-19"}}):e==="chapter19"?E(i,go(),{previous:{href:qt,title:Yt,id:"guidebook-prev-chapter-18"},next:{href:wo,title:fo,id:"guidebook-next-chapter-20"}}):e==="chapter20"?E(i,vo(),{previous:{href:_t,title:jt,id:"guidebook-prev-chapter-19"}}):qr(i),os(i),ts(n),Ro(),t)So(n,t);else if(a){kn();const r=navigator.userAgent??"";typeof requestAnimationFrame=="function"&&r.length>0&&!r.includes("jsdom")&&requestAnimationFrame(()=>kn())}return}}function ls(){const n=document.getElementById("app");if(!n)throw new Error("Missing #app");return n}async function hs(){$n(),Ua();const n=ls(),e=()=>{ss(n)};if(!ba()){window.addEventListener("popstate",e),window.addEventListener("hashchange",()=>{window.location.hash.startsWith("#/")&&e()}),e();try{await ha.open(),await Ja()}catch{}}}hs();
