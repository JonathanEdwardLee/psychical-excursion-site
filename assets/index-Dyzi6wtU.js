...
`,wt="Notice Your Dreams: Dream Awareness, Patterns and Dream Signs",Ni="/dream-awareness-signs/",vt=Ni;let rn=null;function Oi(){return rn||(rn=S(Ci)),rn}const Ma=`# Recognize the Dream: Lucid Dreaming, Reality Checks and Dream Signs
...
`,Wn="Recognize the Dream: Lucid Dreaming, Reality Checks and Dream Signs",Pi="/lucid-dreaming-reality-checks/",Tt=Pi,Li="PEX-IMPLEMENTATION-PLACEHOLDER";let sn=null;function Wi(){const n=Ma.trim();return!n||n.includes(Li)?!1:n.startsWith(`# ${Wn}`)}function Bi(){if(!Wi())throw new Error("Chapter 3 manuscript has not been supplied by PEX_PRIMARY");return sn||(sn=S(Ma)),sn}const Fi=`# Feel the Body: Body Scan Meditation and Deep Relaxation
...
`,kt="Feel the Body: Body Scan Meditation and Deep Relaxation",zi="/body-scan-meditation/",It=zi;let ln=null;function Hi(){return ln||(ln=S(Fi)),ln}const Yi=`# Build the Current: Tingling, Energy Sensations and Focused Attention
...
`,xt="Build the Current: Tingling, Energy Sensations and Focused Attention",qi="/energy-sensations-meditation/",At=qi;let hn=null;function ji(){return hn||(hn=S(Yi)),hn}const _i=`# Quiet the Mind: Meditation Techniques for Sleep and Dream Awareness
...
`,St="Quiet the Mind: Meditation Techniques for Sleep and Dream Awareness",Gi="/meditation-for-lucid-dreaming/",Et=Gi;let cn=null;function Ui(){return cn||(cn=S(_i)),cn}const Vi=`# See the Image: Visualization, Mental Imagery and Hypnagogic Imagery
...
`,Rt="See the Image: Visualization, Mental Imagery and Hypnagogic Imagery",Ji="/visualization-hypnagogic-imagery/",Mt=Ji;let dn=null;function Ki(){return dn||(dn=S(Vi)),dn}const $i=`# Watch the Edge: Hypnagogia and the Transition Into Lucid Dreaming
...
`,Dt="Watch the Edge: Hypnagogia and the Transition Into Lucid Dreaming",Qi="/hypnagogia-lucid-dreaming/",Ct=Qi;let un=null;function Xi(){return un||(un=S($i)),un}const Zi=`# Let the Body Sleep: The “Mind Awake, Body Asleep” Route to Lucid Dreaming
...
`,Nt="Let the Body Sleep: The “Mind Awake, Body Asleep” Route to Lucid Dreaming",eo="/mind-awake-body-asleep/",Ot=eo;let mn=null;function no(){return mn||(mn=S(Zi)),mn}const to=`# Move Without Moving: Motor Imagery, Dream Movement and Sleep-Onset Practice
...
`,Pt="Move Without Moving: Motor Imagery, Dream Movement and Sleep-Onset Practice",ao="/motor-imagery-lucid-dreaming/",Lt=ao;let pn=null;function io(){return pn||(pn=S(to)),pn}const oo=`# Feel the Shift: Vibrations, Floating and Out-of-Body Sensations Near Sleep
...
`,Wt="Feel the Shift: Vibrations, Floating and Out-of-Body Sensations Near Sleep",ro="/out-of-body-sensations-sleep/",Bt=ro;let gn=null;function so(){return gn||(gn=S(oo)),gn}const lo=`# Know the Threshold: How to Recognize When Waking Imagery Becomes a Dream
...
`,Ft="Know the Threshold: How to Recognize When Waking Imagery Becomes a Dream",ho="/entering-a-lucid-dream/",zt=ho;let yn=null;function co(){return yn||(yn=S(lo)),yn}const uo=`# Stabilize the Dream: Lucid Dream Stabilization Techniques and Research
...
`,Ht="Stabilize the Dream: Lucid Dream Stabilization Techniques and Research",mo="/lucid-dream-stabilization/",Yt=mo;let fn=null;function po(){return fn||(fn=S(uo)),fn}const go=`# Explore the Dream: Lucid Dream Experiments, Dream Control and Research
...
`,qt="Explore the Dream: Lucid Dream Experiments, Dream Control and Research",yo="/lucid-dream-experiments/",jt=yo;let bn=null;function fo(){return bn||(bn=S(go)),bn}const bo=`# Loosen the Body: Body Ownership, Self-Location and Out-of-Body Experience
...
`,_t="Loosen the Body: Body Ownership, Self-Location and Out-of-Body Experience",wo="/out-of-body-experience-body-ownership/",Gt=wo;let wn=null;function vo(){return wn||(wn=S(bo)),wn}const To=`# Cross the Threshold: Astral Projection, OBE Techniques and Lucid Dreaming
...
`,Ut="Cross the Threshold: Astral Projection, OBE Techniques and Lucid Dreaming",ko="/astral-projection-obe-techniques/",Vt=ko;let vn=null;function Io(){return vn||(vn=S(To)),vn}const xo=`# Test the Experience: Can Lucid Dreams and Out-of-Body Experiences Be Verified?
...
`,Jt="Test the Experience: Can Lucid Dreams and Out-of-Body Experiences Be Verified?",Ao="/testing-out-of-body-experiences/",Kt=Ao;let Tn=null;function So(){return Tn||(Tn=S(xo)),Tn}const Eo=`# Compare the Maps: Lucid Dreaming vs. Astral Projection, OBE and Sleep Paralysis
...
`,$t="Compare the Maps: Lucid Dreaming vs. Astral Projection, OBE and Sleep Paralysis",Ro="/lucid-dreaming-vs-astral-projection/",Qt=Ro;let kn=null;function Mo(){return kn||(kn=S(Eo)),kn}const Do=`# Floating in Space: Sun, Moon, Planets and the Science of Sleep & Dreams
...
`,Xt="Floating in Space: Sun, Moon, Planets and the Science of Sleep & Dreams",Co="/sun-moon-planets-sleep-dreams/",Zt=Co;let In=null;function No(){return In||(In=S(Do)),In}const Oo=`# Notice the Coincidence: Synchronicity, Recurring Dreams, Shared Dreams and Pattern Recognition
...
`,ea="Notice the Coincidence: Synchronicity, Recurring Dreams, Shared Dreams and Pattern Recognition",Po="/synchronicity-recurring-shared-dreams/",na=Po;let xn=null;function Lo(){return xn||(xn=S(Oo)),xn}const Wo=`# Return. Record. Repeat: The Best Bedtime Routine for Lucid Dreaming and Astral Projection
