...
`,oi=`# Remember Your Dreams: Dream Recall Techniques and Research
...
`,ft="Notice Your Dreams: Dream Awareness, Patterns and Dream Signs",Ei="/dream-awareness-signs/",bt=Ei;let an=null;function Ri(){return an||(an=S(Si)),an}const Aa=`# Recognize the Dream: Lucid Dreaming, Reality Checks and Dream Signs
...
`,Pn="Recognize the Dream: Lucid Dreaming, Reality Checks and Dream Signs",Mi="/lucid-dreaming-reality-checks/",wt=Mi,Di="PEX-IMPLEMENTATION-PLACEHOLDER";let on=null;function Ci(){const n=Aa.trim();return!n||n.includes(Di)?!1:n.startsWith(`# ${Pn}`)}function Ni(){if(!Ci())throw new Error("Chapter 3 manuscript has not been supplied by PEX_PRIMARY");return on||(on=S(Aa)),on}const Oi=`# Feel the Body: Body Scan Meditation and Deep Relaxation
...
`,vt="Feel the Body: Body Scan Meditation and Deep Relaxation",Pi="/body-scan-meditation/",Tt=Pi;let rn=null;function Li(){return rn||(rn=S(Oi)),rn}const Wi=`# Build the Current: Tingling, Energy Sensations and Focused Attention
...
`,kt="Build the Current: Tingling, Energy Sensations and Focused Attention",Bi="/energy-sensations-meditation/",It=Bi;let sn=null;function Fi(){return sn||(sn=S(Wi)),sn}const zi=`# Quiet the Mind: Meditation Techniques for Sleep and Dream Awareness
...
`,xt="Quiet the Mind: Meditation Techniques for Sleep and Dream Awareness",Hi="/meditation-for-lucid-dreaming/",At=Hi;let ln=null;function Yi(){return ln||(ln=S(zi)),ln}const qi=`# See the Image: Visualization, Mental Imagery and Hypnagogic Imagery
...
`,St="See the Image: Visualization, Mental Imagery and Hypnagogic Imagery",ji="/visualization-hypnagogic-imagery/",Et=ji;let hn=null;function _i(){return hn||(hn=S(qi)),hn}const Gi=`# Watch the Edge: Hypnagogia and the Transition Into Lucid Dreaming
...
`,Rt="Watch the Edge: Hypnagogia and the Transition Into Lucid Dreaming",Ui="/hypnagogia-lucid-dreaming/",Mt=Ui;let cn=null;function Vi(){return cn||(cn=S(Gi)),cn}const Ji=`# Let the Body Sleep: The “Mind Awake, Body Asleep” Route to Lucid Dreaming
...
`,Dt="Let the Body Sleep: The “Mind Awake, Body Asleep” Route to Lucid Dreaming",Ki="/mind-awake-body-asleep/",Ct=Ki;let dn=null;function $i(){return dn||(dn=S(Ji)),dn}const Qi=`# Move Without Moving: Motor Imagery, Dream Movement and Sleep-Onset Practice
...
`,Nt="Move Without Moving: Motor Imagery, Dream Movement and Sleep-Onset Practice",Xi="/motor-imagery-lucid-dreaming/",Ot=Xi;let un=null;function Zi(){return un||(un=S(Qi)),un}const eo=`# Feel the Shift: Vibrations, Floating and Out-of-Body Sensations Near Sleep
...
`,Pt="Feel the Shift: Vibrations, Floating and Out-of-Body Sensations Near Sleep",no="/out-of-body-sensations-sleep/",Lt=no;let mn=null;function to(){return mn||(mn=S(eo)),mn}const ao=`# Know the Threshold: How to Recognize When Waking Imagery Becomes a Dream
...
`,Wt="Know the Threshold: How to Recognize When Waking Imagery Becomes a Dream",io="/entering-a-lucid-dream/",Bt=io;let pn=null;function oo(){return pn||(pn=S(ao)),pn}const ro=`# Stabilize the Dream: Lucid Dream Stabilization Techniques and Research
...
`,Ft="Stabilize the Dream: Lucid Dream Stabilization Techniques and Research",so="/lucid-dream-stabilization/",zt=so;let gn=null;function lo(){return gn||(gn=S(ro)),gn}const ho=`# Explore the Dream: Lucid Dream Experiments, Dream Control and Research
...
`,Ht="Explore the Dream: Lucid Dream Experiments, Dream Control and Research",co="/lucid-dream-experiments/",Yt=co;let yn=null;function uo(){return yn||(yn=S(ho)),yn}const mo=`# Loosen the Body: Body Ownership, Self-Location and Out-of-Body Experience
...
`,qt="Loosen the Body: Body Ownership, Self-Location and Out-of-Body Experience",po="/out-of-body-experience-body-ownership/",jt=po;let fn=null;function go(){return fn||(fn=S(mo)),fn}const yo=`# Cross the Threshold: Astral Projection, OBE Techniques and Lucid Dreaming
...
`,_t="Cross the Threshold: Astral Projection, OBE Techniques and Lucid Dreaming",fo="/astral-projection-obe-techniques/",Gt=fo;let bn=null;function bo(){return bn||(bn=S(yo)),bn}const wo=`# Test the Experience: Can Lucid Dreams and Out-of-Body Experiences Be Verified?
...
`,Ut="Test the Experience: Can Lucid Dreams and Out-of-Body Experiences Be Verified?",vo="/testing-out-of-body-experiences/",Vt=vo;let wn=null;function To(){return wn||(wn=S(wo)),wn}const ko=`# Compare the Maps: Lucid Dreaming vs. Astral Projection, OBE and Sleep Paralysis
...
`,Jt="Compare the Maps: Lucid Dreaming vs. Astral Projection, OBE and Sleep Paralysis",Io="/lucid-dreaming-vs-astral-projection/",Kt=Io;let vn=null;function xo(){return vn||(vn=S(ko)),vn}const Ao=`# Floating in Space: Sun, Moon, Planets and the Science of Sleep & Dreams
...
`,$t="Floating in Space: Sun, Moon, Planets and the Science of Sleep & Dreams",So="/sun-moon-planets-sleep-dreams/",Qt=So;let Tn=null;function Eo(){return Tn||(Tn=S(Ao)),Tn}const Ro=`# Notice the Coincidence: Synchronicity, Recurring Dreams, Shared Dreams and Pattern Recognition
...
`,Xt="Notice the Coincidence: Synchronicity, Recurring Dreams, Shared Dreams and Pattern Recognition",Mo="/synchronicity-recurring-shared-dreams/",Zt=Mo;let kn=null;function Do(){return kn||(kn=S(Ro)),kn}const Co=`# Return. Record. Repeat: The Best Bedtime Routine for Lucid Dreaming and Astral Projection
...
`,Zr="An experiment in dreams, consciousness, energy, and out-of-body experience";function es(n){const e=n.trim(),t=e.match(/^#\s+(.+)\n+/);if(!t)throw new Error("Guidebook manuscript must begin with a top-level heading");const a=t[1].trim(),o=e.slice(t[0].length).split(/\n## /),r=da(o[0]??""),s=[];let l=[];for(let h=1;h<o.length;h+=1){const d=o[h],c=d.indexOf(`
`),g=(c===-1?d:d.slice(0,c)).trim(),b=c===-1?"":d.slice(c+1);if(g==="References"){l=ns(b);continue}s.push({heading:g,paragraphs:da(b)})}return{openingHeading:a,openingParagraphs:r,sections:s,references:l}}function da(n){return n.split(/\n---\n/).flatMap(e=>e.split(/\n\n+/)).map(e=>e.replace(/\n/g," ").trim()).filter(Boolean)}function ns(n){return n.split(/\n+/).map(e=>e.trim()).filter(Boolean)}let En=null;function ts(){return En||(En=es(Xr)),En}function ua(n){return n.replace(/[.,;:!?)]+$/u,"")}function je(n,e={}){const{linkCitations:t=!0}=e,a=m("span",{class:"guidebook-rich-text"}),i=t?/(\[[^\]]+\]\((?:pex:[a-z0-9-]+|#\/[^)\s]+)\)|\*\*[^*]+\*\*|\*[^*]+\*|\[\d+\]|https:\/\/\S+|doi:10\.\S+)/gi:/(\[[^\]]+\]\((?:pex:[a-z0-9-]+|#\/[^)\s]+)\)|\*\*[^*]+\*\*|\*[^*]+\*|https:\/\/\S+|doi:10\.\S+)/gi;let o=0;for(const r of n.matchAll(i)){const s=r.index??0;s>o&&a.append(n.slice(o,s));const l=r[0],h=l.match(/^\[([^\]]+)\]\((pex:[a-z0-9-]+|#\/[^)\s]+)\)$/i);if(h){const d=h[1],c=h[2],g=c.toLowerCase().startsWith("pex:")?c.slice(4).toLowerCase():"",b=g?ci[g]:void 0,f=b?.href??(c===Dn||c.endsWith(`#${Xn}`)?Dn:c),T=m("a",{href:f,class:"guidebook-pex-link","data-pex-link":b?.id??Mn}),C=d.match(/^\*\*(.+)\*\*$/);C?T.append(m("strong",{},[C[1]])):T.append(d),a.append(T)}else if(l.startsWith("**"))a.append(m("strong",{},[l.slice(2,-2)]));else if(l.startsWith("*"))a.append(m("em",{},[l.slice(1,-1)]));else if(/^\[\d+\]$/.test(l)&&t){const d=l.slice(1,-1);a.append(m("a",{href:`#ref-${d}`,class:"guidebook-citation"},[l]))}else if(l.toLowerCase().startsWith("doi:10.")){const d=ua(l.slice(4));a.append(m("a",{href:`https://doi.org/${d}`,class:"guidebook-doi",rel:"noreferrer"},[l]))}else if(l.toLowerCase().startsWith("https://")){const d=ua(l);a.append(m("a",{href:d,class:"guidebook-external",rel:"noreferrer"},[l]))}else a.append(l);o=s+l.length}return o<n.length&&a.append(n.slice(o)),a.childNodes.length||a.append(n),a}function Jn(n,e){const t=m("p",{});return t.append(je(n,e)),t}function Va(n){const e=n.match(/^(?:\*\*)?\[(\d+)\](?:\*\*)?\s*(.*)$/),t=e?.[1]??"0",a=e?.[2]??n,i=m("li",{id:`ref-${t}`,class:"guidebook-reference-item"}),o=m("span",{class:"guidebook-ref-num"},[`[${t}] `]);return i.append(o,je(a,{linkCitations:!1})),i.tabIndex=-1,i}function as(n){for(const e of n.querySelectorAll("a.guidebook-citation"))e.addEventListener("click",t=>{const i=(e.getAttribute("href")??"").match(/^#ref-(\d+)$/);if(!i)return;const o=n.querySelector(`#ref-${i[1]}`);if(!o)return;t.preventDefault();const r=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;o.scrollIntoView({behavior:r?"auto":"smooth",block:"start"}),o.focus({preventScroll:!0})});for(const e of n.querySelectorAll("a.guidebook-pex-link"))e.addEventListener("click",t=>{const a=e.getAttribute("href")??"";let i="",o=!0;try{const l=new URL(a,window.location.href);i=l.hash.replace(/^#/,"");const h=window.location.pathname.replace(/\/?$/,"/"),d=l.pathname.replace(/\/?$/,"/");o=d===h||d==="/"||a.startsWith("#")}catch{i=a.includes("#")?a.split("#").pop()??"":""}if(!i||i.startsWith("/")||!o)return;const r=n.querySelector(`[id="${i}"]`);if(!r)return;t.preventDefault(),r.closest(".guidebook-section")?.classList.add("is-visible");const s=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;r.scrollIntoView({behavior:s?"auto":"smooth",block:"start"}),r.focus({preventScroll:!0})})}function Oe(n){return m("section",{class:n?"guidebook-section pex-reveal is-visible":"guidebook-section pex-reveal"})}function is(n){const e=ts(),t=m("article",{class:"guidebook-article"});let a=Oe(!0);t.append(a),a.append(m("p",{class:"guidebook-subtitle"},[Zr]),m("h1",{class:"guidebook-opening-title"},[vi]),m("p",{class:"guidebook-opening-heading"},[e.openingHeading]),...e.openingParagraphs.map(i=>Jn(i)));for(const i of e.sections){a=Oe(!1),t.append(a),a.append(m("h2",{class:"guidebook-section-title"},[i.heading]));for(const o of i.paragraphs){if(o.startsWith("**")&&o.endsWith("**")){a.append(m("p",{class:"guidebook-emphasis-line"},[o.slice(2,-2)]));continue}a.append(Jn(o))}}if(e.references.length){a=Oe(!1),t.append(a),a.append(m("h2",{class:"guidebook-section-title",id:"references"},["References"]));const i=m("ul",{class:"guidebook-references"});for(const o of e.references)i.append(Va(o));a.append(i)}a=Oe(!1),t.append(a),a.append(m("p",{class:"guidebook-next"},[m("a",{href:Ta,class:"guidebook-next-link",id:"guidebook-next-chapter"},[va,m("span",{class:"guidebook-next-arrow","aria-hidden":"true"},[" →"])])])),n.append(t)}const os="My body sleeps. I remain aware. I recognize the transition and calmly enter.",rs="A researched, practical journey through dream recall, attention, lucid dreaming, sleep-edge states, out-of-body experience, verification, strange coincidences, and the question of how far consciousness can go.",ss="Read Psychical Excursion",Pe={innerSeconds:180,midSeconds:240,outerSeconds:300,breatheSeconds:96},_=500,G=500;function v(n,e={}){const t=document.createElementNS("http://www.w3.org/2000/svg",n);for(const[a,i]of Object.entries(e))t.setAttribute(a,i);return t}function A(n,e){const t=(e-90)*Math.PI/180;return[_+n*Math.cos(t),G+n*Math.sin(t)]}function Ja(n,e,t=0){return Array.from({length:n},(a,i)=>A(e,360/n*i+t).join(",")).join(" ")}function ma(n,e,t,a=0){const i=[];for(let o=0;o<n;o+=1)i.push(A(e,360/n*o+a).join(",")),i.push(A(t,360/n*o+180/n+a).join(","));return i.join(" ")}function Rn(n,e,t,a){return[A(t,n),A((e+t)/2,n-a),A(e,n),A((e+t)/2,n+a)].map(i=>i.join(",")).join(" ")}function ls(n,e,t,a){return[A(t,n),A(e,n-a),A(e,n+a)].map(i=>i.join(",")).join(" ")}function j(n,e,t,a,i){n.append(v("polygon",{class:i,points:Ja(e,t,a)}))}function hs(){return typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Ka(){const n=hs(),e=m("figure",{class:n?"pex-attention-instrument is-static":"pex-attention-instrument"});e.setAttribute("role","img"),e.setAttribute("aria-label","Original Psychical Excursion attention instrument: nested thin-line geometry around a fixed center. Looking toward the center is optional. Seeing no afterimage or mental picture is not required.");const t=v("svg",{viewBox:"0 0 1000 1000",focusable:"false"});t.style.setProperty("--pex-attention-inner",`${Pe.innerSeconds}s`),t.style.setProperty("--pex-attention-mid",`${Pe.midSeconds}s`),t.style.setProperty("--pex-attention-outer",`${Pe.outerSeconds}s`),t.style.setProperty("--pex-attention-breathe",`${Pe.breatheSeconds}s`);const a=v("g",{class:"pex-attention-layer pex-attention-beyond"});a.append(v("polygon",{class:"pex-attention-line pex-attention-faintest",points:Ja(36,486,5)})),a.append(v("circle",{class:"pex-attention-line pex-attention-faintest",cx:String(_),cy:String(G),r:"478"}));for(let h=0;h<72;h+=1){const d=h*5,c=A(468,d),g=A(h%6===0?492:484,d);a.append(v("line",{class:"pex-attention-line pex-attention-faintest",x1:c[0].toFixed(2),y1:c[1].toFixed(2),x2:g[0].toFixed(2),y2:g[1].toFixed(2)}))}const i=v("g",{class:"pex-attention-layer pex-attention-spin-outer"});i.append(v("circle",{class:"pex-attention-line pex-attention-strong",cx:String(_),cy:String(G),r:"438"})),i.append(v("circle",{class:"pex-attention-line",cx:String(_),cy:String(G),r:"418"}));for(let h=0;h<144;h+=1){const d=h*2.5,c=h%12===0,g=h%4===0,b=A(c?398:g?406:410,d),f=A(438,d);i.append(v("line",{class:c?"pex-attention-line pex-attention-strong":"pex-attention-line pex-attention-fine",x1:b[0].toFixed(2),y1:b[1].toFixed(2),x2:f[0].toFixed(2),y2:f[1].toFixed(2)}))}for(let h=0;h<8;h+=1){const d=h*45;i.append(v("polygon",{class:"pex-attention-line",points:Rn(d,442,462,3.2)}));const c=A(h%2===0?454:448,d);i.append(v("circle",{class:"pex-attention-fill pex-attention-fine",cx:c[0].toFixed(2),cy:c[1].toFixed(2),r:h%2===0?"2.1":"1.3"}))}for(const h of[18,138,258])i.append(v("path",{class:"pex-attention-line pex-attention-arc",d:cs(394,h,h+84)}));const o=v("g",{class:"pex-attention-layer pex-attention-spin-mid"});for(const h of[372,344,316,288])o.append(v("circle",{class:"pex-attention-line",cx:String(_),cy:String(G),r:String(h)}));j(o,12,372,0,"pex-attention-line pex-attention-soft"),j(o,12,372,15,"pex-attention-line pex-attention-soft");for(let h=0;h<24;h+=1)o.append(v("polygon",{class:"pex-attention-line",points:Rn(h*15,300,368,5.4)}));for(let h=0;h<36;h+=1)o.append(v("polygon",{class:"pex-attention-line pex-attention-fine",points:ls(h*10,248,286,3.6)}));for(let h=0;h<24;h+=1){const d=h*15,c=A(132,d),g=A(h%2===0?368:316,d);o.append(v("line",{class:h%2===0?"pex-attention-line":"pex-attention-line pex-attention-fine",x1:c[0].toFixed(2),y1:c[1].toFixed(2),x2:g[0].toFixed(2),y2:g[1].toFixed(2)}))}const r=v("g",{class:"pex-attention-layer pex-attention-breathe"});j(r,8,236,0,"pex-attention-line pex-attention-strong"),j(r,8,236,22.5,"pex-attention-line"),j(r,6,204,0,"pex-attention-line"),j(r,6,204,30,"pex-attention-line"),j(r,4,176,0,"pex-attention-line pex-attention-soft"),j(r,4,176,45,"pex-attention-line pex-attention-soft"),r.append(v("polygon",{class:"pex-attention-line",points:ma(16,220,148,0)})),r.append(v("polygon",{class:"pex-attention-line pex-attention-fine",points:ma(12,190,126,15)}));for(const h of[168,148,128])r.append(v("circle",{class:"pex-attention-line pex-attention-fine",cx:String(_),cy:String(G),r:String(h)}));const s=v("g",{class:"pex-attention-layer pex-attention-spin-inner"});for(let h=0;h<12;h+=1){const[d,c]=A(34,h*30);s.append(v("circle",{class:"pex-attention-line",cx:d.toFixed(2),cy:c.toFixed(2),r:"34"}))}for(let h=0;h<8;h+=1)s.append(v("polygon",{class:"pex-attention-line pex-attention-fine",points:Rn(h*45+22.5,58,108,8)}));j(s,16,96,0,"pex-attention-line pex-attention-fine"),j(s,8,72,0,"pex-attention-line"),s.append(v("circle",{class:"pex-attention-line",cx:String(_),cy:String(G),r:"54"}));for(let h=0;h<32;h+=1){const d=h*11.25,c=A(46,d),g=A(h%4===0?70:62,d);s.append(v("line",{class:"pex-attention-line pex-attention-fine",x1:c[0].toFixed(2),y1:c[1].toFixed(2),x2:g[0].toFixed(2),y2:g[1].toFixed(2)}))}const l=v("g",{class:"pex-attention-layer pex-attention-center"});return l.append(v("circle",{class:"pex-attention-line pex-attention-strong",cx:String(_),cy:String(G),r:"18"})),l.append(v("circle",{class:"pex-attention-line pex-attention-fine",cx:String(_),cy:String(G),r:"8"})),l.append(v("circle",{class:"pex-attention-fill pex-attention-center-point",cx:String(_),cy:String(G),r:"2.2"})),t.append(a,i,o,r,s,l),e.append(t),e}function cs(n,e,t){const a=A(n,e),i=A(n,t),o=t-e>180?1:0;return`M ${a[0].toFixed(2)} ${a[1].toFixed(2)} A ${n} ${n} 0 ${o} 1 ${i[0].toFixed(2)} ${i[1].toFixed(2)}`}function ds(n){const e=Ka(),t=m("article",{class:"guidebook-article guidebook-landing"},[m("h1",{class:"visually-hidden"},["Psychical Excursion"]),m("div",{class:"guidebook-landing-mandala"},[e]),m("p",{class:"guidebook-landing-affirmation"},[os]),m("p",{class:"guidebook-landing-synopsis"},[rs]),m("p",{class:"guidebook-book-entry"},[m("a",{href:Be,class:"guidebook-next-link guidebook-book-entry-link",id:"guidebook-enter-book"},[ss,m("span",{class:"guidebook-next-arrow","aria-hidden":"true"},[" →"])])])]);n.append(t)}function de(n){return m("section",{class:n?"guidebook-section pex-reveal is-visible":"guidebook-section pex-reveal"})}function $a(n,e,t="guidebook-section-subheading"){for(const a of e){if(a.kind==="emphasis"){n.append(m("p",{class:"guidebook-emphasis-line"},[a.text]));continue}if(a.kind==="quote"){const i=m("blockquote",{class:"guidebook-pull"});i.append(je(a.text)),n.append(i);continue}if(a.kind==="list"){const i=m(a.ordered?"ol":"ul",{class:"guidebook-steps"});for(const o of a.items){const r=m("li",{});r.append(je(o)),i.append(r)}n.append(i);continue}if(a.kind==="rule"){n.append(m("hr",{class:"guidebook-rule"}));continue}if(!(a.kind==="heading"||a.kind==="practice"||a.kind==="attention")){if(a.kind==="subheading"){n.append(m("h3",{class:t},[a.text]));continue}n.append(Jn(a.text))}}}function us(n){const e=m("section",{class:"guidebook-practice-part"});return e.append(m("h2",{class:"guidebook-practice-label"},[n.label])),$a(e,n.blocks,"guidebook-practice-subheading"),e}function ms(n){return m("nav",{class:"guidebook-prev","aria-label":"Previous reading"},[m("a",{href:n.href,class:"guidebook-prev-link",id:n.id},[m("span",{class:"guidebook-prev-arrow","aria-hidden":"true"},["← "]),n.title])])}function x(n,e,t={}){const a=m("article",{class:"guidebook-article guidebook-chapter"});let i=de(!0);a.append(i),t.previous&&i.append(ms(t.previous)),i.append(m("h1",{class:"guidebook-chapter-title"},[e.title]));for(const o of e.blocks){if(o.kind==="heading"){i=de(!1),a.append(i);const r=m("h2",{class:"guidebook-section-title"},[o.text]),s=hi(o.text);s&&(r.id=s,r.tabIndex=-1),i.append(r);continue}if(o.kind==="practice"){i=de(!1),a.append(i);const r=m("aside",{class:"guidebook-practice","aria-label":"Summary, experiment, and intention"});for(const s of o.parts)r.append(us(s));i.append(r);continue}if(o.kind==="attention"){i=de(!1),a.append(i),i.append(Ka());continue}$a(i,[o])}if(e.references.length){i=de(!1),a.append(i),i.append(m("h2",{class:"guidebook-section-title",id:"references"},["References"]));const o=m("ul",{class:"guidebook-references"});for(const r of e.references)o.append(Va(r));i.append(o)}t.next&&(i=de(!1),a.append(i),i.append(m("p",{class:"guidebook-next"},[m("a",{href:t.next.href,class:"guidebook-next-link",id:t.next.id},[t.next.title,m("span",{class:"guidebook-next-arrow","aria-hidden":"true"},[" →"])])]))),n.append(a)}function I(n,e){const t=document.createElementNS("http://www.w3.org/2000/svg",n);for(const[a,i]of Object.entries(e))t.setAttribute(a,i);return t}function ps(n){const e=m("div",{class:`pex-ambient pex-ambient-${n}`,"aria-hidden":"true"}),t=I("svg",{viewBox:"0 0 1200 900",focusable:"false"}),a=I("g",{class:"pex-ambient-spin pex-ambient-spin-slow"});a.append(I("circle",{class:"pex-ambient-arc",cx:"620",cy:"430",r:"318"}),I("circle",{class:"pex-ambient-arc pex-ambient-arc-faint",cx:"620",cy:"430",r:"214"}),I("circle",{class:"pex-ambient-point",cx:"938",cy:"430",r:"2.2"}),I("circle",{class:"pex-ambient-point",cx:"406",cy:"238",r:"1.6"}));const i=I("g",{class:"pex-ambient-spin pex-ambient-spin-mid"});i.append(I("ellipse",{class:"pex-ambient-arc",cx:"580",cy:"400",rx:"430",ry:"168"}),I("path",{class:"pex-ambient-arc pex-ambient-arc-partial",d:"M220 520 C 380 220, 820 180, 1040 470"}),I("circle",{class:"pex-ambient-point",cx:"1010",cy:"400",r:"1.8"}));const o=I("g",{class:"pex-ambient-axis"});if(o.append(I("line",{class:"pex-ambient-line",x1:"600",y1:"40",x2:"600",y2:"860"}),I("line",{class:"pex-ambient-line pex-ambient-line-soft",x1:"80",y1:"390",x2:"1120",y2:"510"})),t.append(o,a,i),n==="memory"){const r=I("g",{class:"pex-ambient-memory-forms"});r.append(I("ellipse",{class:"pex-ambient-form pex-ambient-form-a",cx:"430",cy:"360",rx:"92",ry:"48"}),I("ellipse",{class:"pex-ambient-form pex-ambient-form-b",cx:"760",cy:"500",rx:"70",ry:"110"}),I("circle",{class:"pex-ambient-form pex-ambient-form-c",cx:"620",cy:"280",r:"36"})),t.append(r)}if(n==="notice"||n==="recognize"){const r=I("g",{class:"pex-ambient-notice-align"});r.append(I("path",{class:"pex-ambient-arc pex-ambient-align-a",d:"M260 300 C 480 220, 700 240, 940 360"}),I("path",{class:"pex-ambient-arc pex-ambient-align-b",d:"M300 620 C 520 420, 760 380, 980 520"}),I("circle",{class:"pex-ambient-point pex-ambient-align-point",cx:"640",cy:"390",r:"2.4"})),n==="recognize"&&r.append(I("circle",{class:"pex-ambient-form pex-ambient-recognize-ring",cx:"640",cy:"390",r:"5.5"})),t.append(r)}if(n==="body"){const r=I("g",{class:"pex-ambient-body-forms"});r.append(I("ellipse",{class:"pex-ambient-form pex-ambient-form-a",cx:"620",cy:"318",rx:"36",ry:"48"}),I("ellipse",{class:"pex-ambient-form pex-ambient-form-b",cx:"620",cy:"468",rx:"58",ry:"92"}),I("circle",{class:"pex-ambient-point",cx:"620",cy:"390",r:"1.8"})),t.append(r)}return e.append(t),e}const gs=[{name:"Aries",glyph:"♈︎"},{name:"Taurus",glyph:"♉︎"},{name:"Gemini",glyph:"♊︎"},{name:"Cancer",glyph:"♋︎"},{name:"Leo",glyph:"♌︎"},{name:"Virgo",glyph:"♍︎"},{name:"Libra",glyph:"♎︎"},{name:"Scorpio",glyph:"♏︎"},{name:"Sagittarius",glyph:"♐︎"},{name:"Capricorn",glyph:"♑︎"},{name:"Aquarius",glyph:"♒︎"},{name:"Pisces",glyph:"♓︎"}];function pa(n){const e=(n%360+360)%360;return gs[Math.floor(e/30)%12]}function ys(n){const e=new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric"}).format(n),t=new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"2-digit"}).format(n),a=new Intl.DateTimeFormat(void 0,{month:"long",day:"numeric",hour:"numeric",minute:"2-digit"}).format(n);return{date:e,time:t,spoken:a}}function ga(n,e,t,a){const i=n==="sun"?`Sun in ${t}`:`Moon in ${t}`;return m("span",{class:"sky-widget-pair",tabindex:"0",role:"img","aria-label":i,"data-sky-body":n},[m("span",{class:"sky-widget-body","aria-hidden":"true"},[e]),m("span",{class:"sky-widget-sign","aria-hidden":"true"},[a]),m("span",{class:"sky-widget-tip","aria-hidden":"true"},[i])])}function fs(){const n=new Date,e=$r(n),t=pa(e.sun.eclipticLongitudeDeg),a=pa(e.moon.eclipticLongitudeDeg),i=Vr(n),o=i?ys(i):null,r=o?`Sun in ${t.name}. Moon in ${a.name}. Next full moon ${o.spoken}.`:`Sun in ${t.name}. Moon in ${a.name}.`,s=o?m("span",{class:"sky-widget-full"},[m("span",{class:"sky-widget-full-label"},["Full Moon · "]),m("span",{class:"sky-widget-full-when"},[`${o.date} · ${o.time}`])]):m("span",{class:"sky-widget-full"},["Full Moon"]);return m("div",{class:"sky-widget-compact",role:"group","aria-label":r},[ga("sun",`${_a}${ca}`,t.name,t.glyph),ga("moon",`${Ga}${ca}`,a.name,a.glyph),s])}function bs(n){return n==="chapter01"?"memory":n==="chapter02"?"notice":n==="chapter03"?"recognize":n==="chapter04"?"body":"orbit"}function ws(n){const e=Ii(n);return e?xi(e.title):"Psychical Excursion"}function vs(n,e){Qn(),document.title=ws(e),n.replaceChildren();const t=m("a",{class:"skip-link",href:"#main"},["Skip to content"]),a=bs(e),i=ps(a),o=ks(),r=m("header",{class:"app-header guidebook-header"},[m("a",{href:We,class:"brand-link","aria-label":"Psychical Excursion home"},[m("img",{class:"brand-logo brand-logo-light",src:"/brand/pex-logo-primary.svg",alt:"",width:"220",height:"52",decoding:"async"}),m("img",{class:"brand-logo brand-logo-reverse",src:"/brand/pex-logo-primary-reverse.svg",alt:"",width:"220",height:"52",decoding:"async"})]),m("div",{class:"header-tools guidebook-tools"},[fs(),m("span",{class:"guidebook-tools-rule","aria-hidden":"true"}),o])]),s=m("div",{id:"live-status",class:"visually-hidden","aria-live":"polite"}),l=m("main",{id:"main",class:"main-stage guidebook-main",tabindex:"-1","data-guidebook-page":e}),h=m("footer",{class:"site-footer guidebook-footer"},[m("p",{class:"attribution"},[Vo("Website by "),m("a",{href:"https://hoopsnakedesigns.com/",rel:"noreferrer"},["Hoopsnake Designs"])])]),d=m("div",{class:"app-frame guidebook-frame","data-ambient":a},[r,s,l,h]);return n.append(t,i,d),{main:l}}function Ts(n){as(n)}function ks(){const n=$n()==="bedtime",e=m("button",{type:"button",id:"theme-light-dark",class:"theme-switch",role:"switch",dir:"ltr","aria-checked":n?"true":"false","aria-label":"Dark appearance"},[m("span",{class:"theme-switch-track","aria-hidden":"true",dir:"ltr"},[m("span",{class:"theme-switch-thumb"})])]);return e.addEventListener("click",()=>{const a=ii()==="bedtime";e.setAttribute("aria-checked",a?"true":"false")}),e}const Kn=[];function Qa(){for(;Kn.length;)Kn.pop()?.()}function Is(){return typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function xs(n){Qa();const e=[...n.querySelectorAll(".pex-reveal")];if(e.length===0)return;if(Is()||typeof IntersectionObserver!="function"){for(const a of e)a.classList.add("is-visible");return}e[0]?.classList.add("is-visible");const t=new IntersectionObserver(a=>{for(const i of a)i.isIntersecting&&(i.target.classList.add("is-visible"),t.unobserve(i.target))},{threshold:.08,rootMargin:"0px 0px -10% 0px"});for(const a of e)t.observe(a);Kn.push(()=>t.disconnect())}const ya=[];function As(){for(;ya.length;)ya.pop()?.()}async function Ss(n){{if(Sa())return;Jo(),Qr(),As(),Qa();const e=zo(),t=Fo(),a=Ho(e);a&&!t&&xn(),Yo(e);const{main:i}=vs(n,e),o={href:Be,title:"Introduction",id:"guidebook-prev-home"};if(e==="chapter01"?x(i,gi(),{previous:o,next:{href:bt,title:ft,id:"guidebook-next-chapter-2"}}):e==="chapter02"?x(i,Ri(),{previous:{href:ui,title:va,id:"guidebook-prev-chapter-1"},next:{href:wt,title:Pn,id:"guidebook-next-chapter-3"}}):e==="chapter03"?x(i,Ni(),{previous:{href:bt,title:ft,id:"guidebook-prev-chapter-2"},next:{href:Tt,title:vt,id:"guidebook-next-chapter-4"}}):e==="chapter04"?x(i,Li(),{previous:{href:wt,title:Pn,id:"guidebook-prev-chapter-3"},next:Le()?{href:yt,title:On,id:"guidebook-next-chapter-5"}:void 0}):e==="chapter05"&&Le()?x(i,bi(),{previous:{href:Tt,title:vt,id:"guidebook-prev-chapter-4"},next:{href:It,title:kt,id:"guidebook-next-chapter-6"}}):e==="chapter06"?x(i,Fi(),{previous:{href:yt,title:On,id:"guidebook-prev-chapter-5"},next:{href:At,title:xt,id:"guidebook-next-chapter-7"}}):e==="chapter07"?x(i,Yi(),{previous:{href:It,title:kt,id:"guidebook-prev-chapter-6"},next:{href:Et,title:St,id:"guidebook-next-chapter-8"}}):e==="chapter08"?x(i,_i(),{previous:{href:At,title:xt,id:"guidebook-prev-chapter-7"},next:{href:Mt,title:Rt,id:"guidebook-next-chapter-9"}}):e==="chapter09"?x(i,Vi(),{previous:{href:Et,title:St,id:"guidebook-prev-chapter-8"},next:{href:Ct,title:Dt,id:"guidebook-next-chapter-10"}}):e==="chapter10"?x(i,$i(),{previous:{href:Mt,title:Rt,id:"guidebook-prev-chapter-9"},next:{href:Ot,title:Nt,id:"guidebook-next-chapter-11"}}):e==="chapter11"?x(i,Zi(),{previous:{href:Ct,title:Dt,id:"guidebook-prev-chapter-10"},next:{href:Lt,title:Pt,id:"guidebook-next-chapter-12"}}):e==="chapter12"?x(i,to(),{previous:{href:Ot,title:Nt,id:"guidebook-prev-chapter-11"},next:{href:Bt,title:Wt,id:"guidebook-next-chapter-13"}}):e==="chapter13"?x(i,oo(),{previous:{href:Lt,title:Pt,id:"guidebook-prev-chapter-12"},next:{href:zt,title:Ft,id:"guidebook-next-chapter-14"}}):e==="chapter14"?x(i,lo(),{previous:{href:Bt,title:Wt,id:"guidebook-prev-chapter-13"},next:{href:Yt,title:Ht,id:"guidebook-next-chapter-15"}}):e==="chapter15"?x(i,uo(),{previous:{href:zt,title:Ft,id:"guidebook-prev-chapter-14"},next:{href:jt,title:qt,id:"guidebook-next-chapter-16"}}):e==="chapter16"?x(i,go(),{previous:{href:Yt,title:Ht,id:"guidebook-prev-chapter-15"},next:{href:Gt,title:_t,id:"guidebook-next-chapter-17"}}):e==="chapter17"?x(i,bo(),{previous:{href:jt,title:qt,id:"guidebook-prev-chapter-16"},next:{href:Vt,title:Ut,id:"guidebook-next-chapter-18"}}):e==="chapter18"?x(i,To(),{previous:{href:Gt,title:_t,id:"guidebook-prev-chapter-17"},next:{href:Kt,title:Jt,id:"guidebook-next-chapter-19"}}):e==="chapter19"?x(i,xo(),{previous:{href:Vt,title:Ut,id:"guidebook-prev-chapter-18"},next:{href:Qt,title:$t,id:"guidebook-next-chapter-20"}}):e==="chapter20"?x(i,Eo(),{previous:{href:Kt,title:Jt,id:"guidebook-prev-chapter-19"},next:{href:Zt,title:Xt,id:"guidebook-next-chapter-21"}}):e==="chapter21"?x(i,Do(),{previous:{href:Qt,title:$t,id:"guidebook-prev-chapter-20"},next:{href:Po,title:No,id:"guidebook-next-chapter-22"}}):e==="chapter22"?x(i,Lo(),{previous:{href:Zt,title:Xt,id:"guidebook-prev-chapter-21"}}):e==="landing"?ds(i):is(i),xs(i),Ts(n),_o(),t)qo(n,t);else if(a){xn();const r=navigator.userAgent??"";typeof requestAnimationFrame=="function"&&r.length>0&&!r.includes("jsdom")&&requestAnimationFrame(()=>xn())}return}}function Es(){const n=document.getElementById("app");if(!n)throw new Error("Missing #app");return n}async function Rs(){Qn(),ti();const n=Es(),e=()=>{Ss(n)};if(!Sa()){window.addEventListener("popstate",e),window.addEventListener("hashchange",()=>{window.location.hash.startsWith("#/")&&e()}),e();try{await fa.open(),await ai()}catch{}}}Rs();
