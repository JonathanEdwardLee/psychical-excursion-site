...
`,Va=`# Remember Your Dreams: Dream Recall Techniques and Research
...
`,dt="Notice Your Dreams: Dream Awareness, Patterns and Dream Signs",gi="/dream-awareness-signs/",ut=gi;let an=null;function yi(){return an||(an=D(pi)),an}const pa=`# Recognize the Dream: Lucid Dreaming, Reality Checks and Dream Signs
...
`,Cn="Recognize the Dream: Lucid Dreaming, Reality Checks and Dream Signs",fi="/lucid-dreaming-reality-checks/",mt=fi,bi="PEX-IMPLEMENTATION-PLACEHOLDER";let on=null;function wi(){const n=pa.trim();return!n||n.includes(bi)?!1:n.startsWith(`# ${Cn}`)}function vi(){if(!wi())throw new Error("Chapter 3 manuscript has not been supplied by PEX_PRIMARY");return on||(on=D(pa)),on}const Ti=`# Feel the Body: Body Scan Meditation and Deep Relaxation
...
`,pt="Feel the Body: Body Scan Meditation and Deep Relaxation",ki="/body-scan-meditation/",gt=ki;let rn=null;function Ii(){return rn||(rn=D(Ti)),rn}const xi=`# Build the Current: Tingling, Energy Sensations and Focused Attention
...
`,yt="Build the Current: Tingling, Energy Sensations and Focused Attention",Ai="/energy-sensations-meditation/",ft=Ai;let sn=null;function Si(){return sn||(sn=D(xi)),sn}const Ei=`# Quiet the Mind: Meditation Techniques for Sleep and Dream Awareness
...
`,bt="Quiet the Mind: Meditation Techniques for Sleep and Dream Awareness",Ri="/meditation-for-lucid-dreaming/",wt=Ri;let ln=null;function Mi(){return ln||(ln=D(Ei)),ln}const Di=`# See the Image: Visualization, Mental Imagery and Hypnagogic Imagery
...
`,vt="See the Image: Visualization, Mental Imagery and Hypnagogic Imagery",Ci="/visualization-hypnagogic-imagery/",Tt=Ci;let hn=null;function Ni(){return hn||(hn=D(Di)),hn}const Oi=`# Watch the Edge: Hypnagogia and the Transition Into Lucid Dreaming
...
`,kt="Watch the Edge: Hypnagogia and the Transition Into Lucid Dreaming",Pi="/hypnagogia-lucid-dreaming/",It=Pi;let cn=null;function Li(){return cn||(cn=D(Oi)),cn}const Wi=`# Let the Body Sleep: The “Mind Awake, Body Asleep” Route to Lucid Dreaming
...
`,xt="Let the Body Sleep: The “Mind Awake, Body Asleep” Route to Lucid Dreaming",Fi="/mind-awake-body-asleep/",At=Fi;let dn=null;function Bi(){return dn||(dn=D(Wi)),dn}const Yi=`# Move Without Moving: Motor Imagery, Dream Movement and Sleep-Onset Practice
...
`,St="Move Without Moving: Motor Imagery, Dream Movement and Sleep-Onset Practice",Hi="/motor-imagery-lucid-dreaming/",Et=Hi;let un=null;function zi(){return un||(un=D(Yi)),un}const qi=`# Feel the Shift: Vibrations, Floating and Out-of-Body Sensations Near Sleep
...
`,Rt="Feel the Shift: Vibrations, Floating and Out-of-Body Sensations Near Sleep",ji="/out-of-body-sensations-sleep/",Mt=ji;let mn=null;function _i(){return mn||(mn=D(qi)),mn}const Gi=`# Know the Threshold: How to Recognize When Waking Imagery Becomes a Dream
...
`,Dt="Know the Threshold: How to Recognize When Waking Imagery Becomes a Dream",Ui="/entering-a-lucid-dream/",Ct=Ui;let pn=null;function Vi(){return pn||(pn=D(Gi)),pn}const $i=`# Stabilize the Dream: Lucid Dream Stabilization Techniques and Research
...
`,Nt="Stabilize the Dream: Lucid Dream Stabilization Techniques and Research",Ki="/lucid-dream-stabilization/",Ot=Ki;let gn=null;function Ji(){return gn||(gn=D($i)),gn}const Qi=`# Explore the Dream: Lucid Dream Experiments, Dream Control and Research
...
`,Pt="Explore the Dream: Lucid Dream Experiments, Dream Control and Research",Xi="/lucid-dream-experiments/",Lt=Xi;let yn=null;function Zi(){return yn||(yn=D(Qi)),yn}const eo=`# Loosen the Body: Body Ownership, Self-Location and Out-of-Body Experience
...
`,Wt="Loosen the Body: Body Ownership, Self-Location and Out-of-Body Experience",no="/out-of-body-experience-body-ownership/",Ft=no;let fn=null;function to(){return fn||(fn=D(eo)),fn}const ao=`# Cross the Threshold: Astral Projection, OBE Techniques and Lucid Dreaming
...
`,Bt="Cross the Threshold: Astral Projection, OBE Techniques and Lucid Dreaming",io="/astral-projection-obe-techniques/",Yt=io;let bn=null;function oo(){return bn||(bn=D(ao)),bn}const ro=`# Test the Experience: Can Lucid Dreams and Out-of-Body Experiences Be Verified?
...
`,Ht="Test the Experience: Can Lucid Dreams and Out-of-Body Experiences Be Verified?",so="/testing-out-of-body-experiences/",zt=so;let wn=null;function lo(){return wn||(wn=D(ro)),wn}const ho=`# Compare the Maps: Lucid Dreaming vs. Astral Projection, OBE and Sleep Paralysis
...
`,Cr="An experiment in dreams, consciousness, energy, and out-of-body experience";function Nr(n){const e=n.trim(),t=e.match(/^#\s+(.+)\n+/);if(!t)throw new Error("Guidebook manuscript must begin with a top-level heading");const a=t[1].trim(),o=e.slice(t[0].length).split(/\n## /),r=ea(o[0]??""),s=[];let l=[];for(let h=1;h<o.length;h+=1){const d=o[h],c=d.indexOf(`
`),g=(c===-1?d:d.slice(0,c)).trim(),b=c===-1?"":d.slice(c+1);if(g==="References"){l=Or(b);continue}s.push({heading:g,paragraphs:ea(b)})}return{openingHeading:a,openingParagraphs:r,sections:s,references:l}}function ea(n){return n.split(/\n---\n/).flatMap(e=>e.split(/\n\n+/)).map(e=>e.replace(/\n/g," ").trim()).filter(Boolean)}function Or(n){return n.split(/\n+/).map(e=>e.trim()).filter(Boolean)}let xn=null;function Pr(){return xn||(xn=Nr(Dr)),xn}function na(n){return n.replace(/[.,;:!?)]+$/u,"")}function qe(n,e={}){const{linkCitations:t=!0}=e,a=m("span",{class:"guidebook-rich-text"}),i=t?/(\[[^\]]+\]\((?:pex:[a-z0-9-]+|#\/[^)\s]+)\)|\*\*[^*]+\*\*|\*[^*]+\*|\[\d+\]|https:\/\/\S+|doi:10\.\S+)/gi:/(\[[^\]]+\]\((?:pex:[a-z0-9-]+|#\/[^)\s]+)\)|\*\*[^*]+\*\*|\*[^*]+\*|https:\/\/\S+|doi:10\.\S+)/gi;let o=0;for(const r of n.matchAll(i)){const s=r.index??0;s>o&&a.append(n.slice(o,s));const l=r[0],h=l.match(/^\[([^\]]+)\]\((pex:[a-z0-9-]+|#\/[^)\s]+)\)$/i);if(h){const d=h[1],c=h[2],g=c.toLowerCase().startsWith("pex:")?c.slice(4).toLowerCase():"",b=g?Xa[g]:void 0,f=b?.href??(c===En||c.endsWith(`#${Kn}`)?En:c),T=m("a",{href:f,class:"guidebook-pex-link","data-pex-link":b?.id??Sn}),C=d.match(/^\*\*(.+)\*\*$/);C?T.append(m("strong",{},[C[1]])):T.append(d),a.append(T)}else if(l.startsWith("**"))a.append(m("strong",{},[l.slice(2,-2)]));else if(l.startsWith("*"))a.append(m("em",{},[l.slice(1,-1)]));else if(/^\[\d+\]$/.test(l)&&t){const d=l.slice(1,-1);a.append(m("a",{href:`#ref-${d}`,class:"guidebook-citation"},[l]))}else if(l.toLowerCase().startsWith("doi:10.")){const d=na(l.slice(4));a.append(m("a",{href:`https://doi.org/${d}`,class:"guidebook-doi",rel:"noreferrer"},[l]))}else if(l.toLowerCase().startsWith("https://")){const d=na(l);a.append(m("a",{href:d,class:"guidebook-external",rel:"noreferrer"},[l]))}else a.append(l);o=s+l.length}return o<n.length&&a.append(n.slice(o)),a.childNodes.length||a.append(n),a}function Gn(n,e){const t=m("p",{});return t.append(qe(n,e)),t}function Wa(n){const e=n.match(/^(?:\*\*)?\[(\d+)\](?:\*\*)?\s*(.*)$/),t=e?.[1]??"0",a=e?.[2]??n,i=m("li",{id:`ref-${t}`,class:"guidebook-reference-item"}),o=m("span",{class:"guidebook-ref-num"},[`[${t}] `]);return i.append(o,qe(a,{linkCitations:!1})),i.tabIndex=-1,i}function Lr(n){for(const e of n.querySelectorAll("a.guidebook-citation"))e.addEventListener("click",t=>{const i=(e.getAttribute("href")??"").match(/^#ref-(\d+)$/);if(!i)return;const o=n.querySelector(`#ref-${i[1]}`);if(!o)return;t.preventDefault();const r=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;o.scrollIntoView({behavior:r?"auto":"smooth",block:"start"}),o.focus({preventScroll:!0})});for(const e of n.querySelectorAll("a.guidebook-pex-link"))e.addEventListener("click",t=>{const a=e.getAttribute("href")??"";let i="",o=!0;try{const l=new URL(a,window.location.href);i=l.hash.replace(/^#/,"");const h=window.location.pathname.replace(/\/?$/,"/"),d=l.pathname.replace(/\/?$/,"/");o=d===h||d==="/"||a.startsWith("#")}catch{i=a.includes("#")?a.split("#").pop()??"":""}if(!i||i.startsWith("/")||!o)return;const r=n.querySelector(`[id="${i}"]`);if(!r)return;t.preventDefault(),r.closest(".guidebook-section")?.classList.add("is-visible");const s=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;r.scrollIntoView({behavior:s?"auto":"smooth",block:"start"}),r.focus({preventScroll:!0})})}function Pe(n){return m("section",{class:n?"guidebook-section pex-reveal is-visible":"guidebook-section pex-reveal"})}function Wr(n){const e=Pr(),t=m("article",{class:"guidebook-article"});let a=Pe(!0);t.append(a),a.append(m("p",{class:"guidebook-subtitle"},[Cr]),m("h1",{class:"guidebook-opening-title"},[li]),m("p",{class:"guidebook-opening-heading"},[e.openingHeading]),...e.openingParagraphs.map(i=>Gn(i)));for(const i of e.sections){a=Pe(!1),t.append(a),a.append(m("h2",{class:"guidebook-section-title"},[i.heading]));for(const o of i.paragraphs){if(o.startsWith("**")&&o.endsWith("**")){a.append(m("p",{class:"guidebook-emphasis-line"},[o.slice(2,-2)]));continue}a.append(Gn(o))}}if(e.references.length){a=Pe(!1),t.append(a),a.append(m("h2",{class:"guidebook-section-title",id:"references"},["References"]));const i=m("ul",{class:"guidebook-references"});for(const o of e.references)i.append(Wa(o));a.append(i)}a=Pe(!1),t.append(a),a.append(m("p",{class:"guidebook-next"},[m("a",{href:ca,class:"guidebook-next-link",id:"guidebook-next-chapter"},[ha,m("span",{class:"guidebook-next-arrow","aria-hidden":"true"},[" →"])])])),n.append(t)}const Le={innerSeconds:180,midSeconds:240,outerSeconds:300,breatheSeconds:96},_=500,G=500;function v(n,e={}){const t=document.createElementNS("http://www.w3.org/2000/svg",n);for(const[a,i]of Object.entries(e))t.setAttribute(a,i);return t}function x(n,e){const t=(e-90)*Math.PI/180;return[_+n*Math.cos(t),G+n*Math.sin(t)]}function Fa(n,e,t=0){return Array.from({length:n},(a,i)=>x(e,360/n*i+t).join(",")).join(" ")}function ta(n,e,t,a=0){const i=[];for(let o=0;o<n;o+=1)i.push(x(e,360/n*o+a).join(",")),i.push(x(t,360/n*o+180/n+a).join(","));return i.join(" ")}function An(n,e,t,a){return[x(t,n),x((e+t)/2,n-a),x(e,n),x((e+t)/2,n+a)].map(i=>i.join(",")).join(" ")}function Fr(n,e,t,a){return[x(t,n),x(e,n-a),x(e,n+a)].map(i=>i.join(",")).join(" ")}function j(n,e,t,a,i){n.append(v("polygon",{class:i,points:Fa(e,t,a)}))}function Br(){return typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Yr(){const n=Br(),e=m("figure",{class:n?"pex-attention-instrument is-static":"pex-attention-instrument"});e.setAttribute("role","img"),e.setAttribute("aria-label","Original Psychical Excursion attention instrument: nested thin-line geometry around a fixed center. Looking toward the center is optional. Seeing no afterimage or mental picture is not required.");const t=v("svg",{viewBox:"0 0 1000 1000",focusable:"false"});t.style.setProperty("--pex-attention-inner",`${Le.innerSeconds}s`),t.style.setProperty("--pex-attention-mid",`${Le.midSeconds}s`),t.style.setProperty("--pex-attention-outer",`${Le.outerSeconds}s`),t.style.setProperty("--pex-attention-breathe",`${Le.breatheSeconds}s`);const a=v("g",{class:"pex-attention-layer pex-attention-beyond"});a.append(v("polygon",{class:"pex-attention-line pex-attention-faintest",points:Fa(36,486,5)})),a.append(v("circle",{class:"pex-attention-line pex-attention-faintest",cx:String(_),cy:String(G),r:"478"}));for(let h=0;h<72;h+=1){const d=h*5,c=x(468,d),g=x(h%6===0?492:484,d);a.append(v("line",{class:"pex-attention-line pex-attention-faintest",x1:c[0].toFixed(2),y1:c[1].toFixed(2),x2:g[0].toFixed(2),y2:g[1].toFixed(2)}))}const i=v("g",{class:"pex-attention-layer pex-attention-spin-outer"});i.append(v("circle",{class:"pex-attention-line pex-attention-strong",cx:String(_),cy:String(G),r:"438"})),i.append(v("circle",{class:"pex-attention-line",cx:String(_),cy:String(G),r:"418"}));for(let h=0;h<144;h+=1){const d=h*2.5,c=h%12===0,g=h%4===0,b=x(c?398:g?406:410,d),f=x(438,d);i.append(v("line",{class:c?"pex-attention-line pex-attention-strong":"pex-attention-line pex-attention-fine",x1:b[0].toFixed(2),y1:b[1].toFixed(2),x2:f[0].toFixed(2),y2:f[1].toFixed(2)}))}for(let h=0;h<8;h+=1){const d=h*45;i.append(v("polygon",{class:"pex-attention-line",points:An(d,442,462,3.2)}));const c=x(h%2===0?454:448,d);i.append(v("circle",{class:"pex-attention-fill pex-attention-fine",cx:c[0].toFixed(2),cy:c[1].toFixed(2),r:h%2===0?"2.1":"1.3"}))}for(const h of[18,138,258])i.append(v("path",{class:"pex-attention-line pex-attention-arc",d:Hr(394,h,h+84)}));const o=v("g",{class:"pex-attention-layer pex-attention-spin-mid"});for(const h of[372,344,316,288])o.append(v("circle",{class:"pex-attention-line",cx:String(_),cy:String(G),r:String(h)}));j(o,12,372,0,"pex-attention-line pex-attention-soft"),j(o,12,372,15,"pex-attention-line pex-attention-soft");for(let h=0;h<24;h+=1)o.append(v("polygon",{class:"pex-attention-line",points:An(h*15,300,368,5.4)}));for(let h=0;h<36;h+=1)o.append(v("polygon",{class:"pex-attention-line pex-attention-fine",points:Fr(h*10,248,286,3.6)}));for(let h=0;h<24;h+=1){const d=h*15,c=x(132,d),g=x(h%2===0?368:316,d);o.append(v("line",{class:h%2===0?"pex-attention-line":"pex-attention-line pex-attention-fine",x1:c[0].toFixed(2),y1:c[1].toFixed(2),x2:g[0].toFixed(2),y2:g[1].toFixed(2)}))}const r=v("g",{class:"pex-attention-layer pex-attention-breathe"});j(r,8,236,0,"pex-attention-line pex-attention-strong"),j(r,8,236,22.5,"pex-attention-line"),j(r,6,204,0,"pex-attention-line"),j(r,6,204,30,"pex-attention-line"),j(r,4,176,0,"pex-attention-line pex-attention-soft"),j(r,4,176,45,"pex-attention-line pex-attention-soft"),r.append(v("polygon",{class:"pex-attention-line",points:ta(16,220,148,0)})),r.append(v("polygon",{class:"pex-attention-line pex-attention-fine",points:ta(12,190,126,15)}));for(const h of[168,148,128])r.append(v("circle",{class:"pex-attention-line pex-attention-fine",cx:String(_),cy:String(G),r:String(h)}));const s=v("g",{class:"pex-attention-layer pex-attention-spin-inner"});for(let h=0;h<12;h+=1){const[d,c]=x(34,h*30);s.append(v("circle",{class:"pex-attention-line",cx:d.toFixed(2),cy:c.toFixed(2),r:"34"}))}for(let h=0;h<8;h+=1)s.append(v("polygon",{class:"pex-attention-line pex-attention-fine",points:An(h*45+22.5,58,108,8)}));j(s,16,96,0,"pex-attention-line pex-attention-fine"),j(s,8,72,0,"pex-attention-line"),s.append(v("circle",{class:"pex-attention-line",cx:String(_),cy:String(G),r:"54"}));for(let h=0;h<32;h+=1){const d=h*11.25,c=x(46,d),g=x(h%4===0?70:62,d);s.append(v("line",{class:"pex-attention-line pex-attention-fine",x1:c[0].toFixed(2),y1:c[1].toFixed(2),x2:g[0].toFixed(2),y2:g[1].toFixed(2)}))}const l=v("g",{class:"pex-attention-layer pex-attention-center"});return l.append(v("circle",{class:"pex-attention-line pex-attention-strong",cx:String(_),cy:String(G),r:"18"})),l.append(v("circle",{class:"pex-attention-line pex-attention-fine",cx:String(_),cy:String(G),r:"8"})),l.append(v("circle",{class:"pex-attention-fill pex-attention-center-point",cx:String(_),cy:String(G),r:"2.2"})),t.append(a,i,o,r,s,l),e.append(t),e}function Hr(n,e,t){const a=x(n,e),i=x(n,t),o=t-e>180?1:0;return`M ${a[0].toFixed(2)} ${a[1].toFixed(2)} A ${n} ${n} 0 ${o} 1 ${i[0].toFixed(2)} ${i[1].toFixed(2)}`}function ue(n){return m("section",{class:n?"guidebook-section pex-reveal is-visible":"guidebook-section pex-reveal"})}function Ba(n,e){for(const t of e){if(t.kind==="emphasis"){n.append(m("p",{class:"guidebook-emphasis-line"},[t.text]));continue}if(t.kind==="quote"){const a=m("blockquote",{class:"guidebook-pull"});a.append(qe(t.text)),n.append(a);continue}if(t.kind==="list"){const a=m(t.ordered?"ol":"ul",{class:"guidebook-steps"});for(const i of t.items){const o=m("li",{});o.append(qe(i)),a.append(o)}n.append(a);continue}if(t.kind==="rule"){n.append(m("hr",{class:"guidebook-rule"}));continue}if(!(t.kind==="heading"||t.kind==="practice"||t.kind==="attention")){if(t.kind==="subheading"){n.append(m("h3",{class:"guidebook-practice-subheading"},[t.text]));continue}n.append(Gn(t.text))}}}function zr(n){const e=m("section",{class:"guidebook-practice-part"});return e.append(m("h2",{class:"guidebook-practice-label"},[n.label])),Ba(e,n.blocks),e}function qr(n){return m("nav",{class:"guidebook-prev","aria-label":"Previous reading"},[m("a",{href:n.href,class:"guidebook-prev-link",id:n.id},[m("span",{class:"guidebook-prev-arrow","aria-hidden":"true"},["← "]),n.title])])}function M(n,e,t={}){const a=m("article",{class:"guidebook-article guidebook-chapter"});let i=ue(!0);a.append(i),t.previous&&i.append(qr(t.previous)),i.append(m("h1",{class:"guidebook-chapter-title"},[e.title]));for(const o of e.blocks){if(o.kind==="heading"){i=ue(!1),a.append(i);const r=m("h2",{class:"guidebook-section-title"},[o.text]),s=Qa(o.text);s&&(r.id=s,r.tabIndex=-1),i.append(r);continue}if(o.kind==="practice"){i=ue(!1),a.append(i);const r=m("aside",{class:"guidebook-practice","aria-label":"Summary, experiment, and intention"});for(const s of o.parts)r.append(zr(s));i.append(r);continue}if(o.kind==="attention"){i=ue(!1),a.append(i),i.append(Yr());continue}Ba(i,[o])}if(e.references.length){i=ue(!1),a.append(i),i.append(m("h2",{class:"guidebook-section-title",id:"references"},["References"]));const o=m("ul",{class:"guidebook-references"});for(const r of e.references)o.append(Wa(r));i.append(o)}t.next&&(i=ue(!1),a.append(i),i.append(m("p",{class:"guidebook-next"},[m("a",{href:t.next.href,class:"guidebook-next-link",id:t.next.id},[t.next.title,m("span",{class:"guidebook-next-arrow","aria-hidden":"true"},[" →"])])]))),n.append(a)}function I(n,e){const t=document.createElementNS("http://www.w3.org/2000/svg",n);for(const[a,i]of Object.entries(e))t.setAttribute(a,i);return t}function jr(n){const e=m("div",{class:`pex-ambient pex-ambient-${n}`,"aria-hidden":"true"}),t=I("svg",{viewBox:"0 0 1200 900",focusable:"false"}),a=I("g",{class:"pex-ambient-spin pex-ambient-spin-slow"});a.append(I("circle",{class:"pex-ambient-arc",cx:"620",cy:"430",r:"318"}),I("circle",{class:"pex-ambient-arc pex-ambient-arc-faint",cx:"620",cy:"430",r:"214"}),I("circle",{class:"pex-ambient-point",cx:"938",cy:"430",r:"2.2"}),I("circle",{class:"pex-ambient-point",cx:"406",cy:"238",r:"1.6"}));const i=I("g",{class:"pex-ambient-spin pex-ambient-spin-mid"});i.append(I("ellipse",{class:"pex-ambient-arc",cx:"580",cy:"400",rx:"430",ry:"168"}),I("path",{class:"pex-ambient-arc pex-ambient-arc-partial",d:"M220 520 C 380 220, 820 180, 1040 470"}),I("circle",{class:"pex-ambient-point",cx:"1010",cy:"400",r:"1.8"}));const o=I("g",{class:"pex-ambient-axis"});if(o.append(I("line",{class:"pex-ambient-line",x1:"600",y1:"40",x2:"600",y2:"860"}),I("line",{class:"pex-ambient-line pex-ambient-line-soft",x1:"80",y1:"390",x2:"1120",y2:"510"})),t.append(o,a,i),n==="memory"){const r=I("g",{class:"pex-ambient-memory-forms"});r.append(I("ellipse",{class:"pex-ambient-form pex-ambient-form-a",cx:"430",cy:"360",rx:"92",ry:"48"}),I("ellipse",{class:"pex-ambient-form pex-ambient-form-b",cx:"760",cy:"500",rx:"70",ry:"110"}),I("circle",{class:"pex-ambient-form pex-ambient-form-c",cx:"620",cy:"280",r:"36"})),t.append(r)}if(n==="notice"||n==="recognize"){const r=I("g",{class:"pex-ambient-notice-align"});r.append(I("path",{class:"pex-ambient-arc pex-ambient-align-a",d:"M260 300 C 480 220, 700 240, 940 360"}),I("path",{class:"pex-ambient-arc pex-ambient-align-b",d:"M300 620 C 520 420, 760 380, 980 520"}),I("circle",{class:"pex-ambient-point pex-ambient-align-point",cx:"640",cy:"390",r:"2.4"})),n==="recognize"&&r.append(I("circle",{class:"pex-ambient-form pex-ambient-recognize-ring",cx:"640",cy:"390",r:"5.5"})),t.append(r)}if(n==="body"){const r=I("g",{class:"pex-ambient-body-forms"});r.append(I("ellipse",{class:"pex-ambient-form pex-ambient-form-a",cx:"620",cy:"318",rx:"36",ry:"48"}),I("ellipse",{class:"pex-ambient-form pex-ambient-form-b",cx:"620",cy:"468",rx:"58",ry:"92"}),I("circle",{class:"pex-ambient-point",cx:"620",cy:"390",r:"1.8"})),t.append(r)}return e.append(t),e}const _r=[{name:"Aries",glyph:"♈︎"},{name:"Taurus",glyph:"♉︎"},{name:"Gemini",glyph:"♊︎"},{name:"Cancer",glyph:"♋︎"},{name:"Leo",glyph:"♌︎"},{name:"Virgo",glyph:"♍︎"},{name:"Libra",glyph:"♎︎"},{name:"Scorpio",glyph:"♏︎"},{name:"Sagittarius",glyph:"♐︎"},{name:"Capricorn",glyph:"♑︎"},{name:"Aquarius",glyph:"♒︎"},{name:"Pisces",glyph:"♓︎"}];function aa(n){const e=(n%360+360)%360;return _r[Math.floor(e/30)%12]}function Gr(n){const e=new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric"}).format(n),t=new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"2-digit"}).format(n),a=new Intl.DateTimeFormat(void 0,{month:"long",day:"numeric",hour:"numeric",minute:"2-digit"}).format(n);return{date:e,time:t,spoken:a}}function ia(n,e,t,a){const i=n==="sun"?`Sun in ${t}`:`Moon in ${t}`;return m("span",{class:"sky-widget-pair",tabindex:"0",role:"img","aria-label":i,"data-sky-body":n},[m("span",{class:"sky-widget-body","aria-hidden":"true"},[e]),m("span",{class:"sky-widget-sign","aria-hidden":"true"},[a]),m("span",{class:"sky-widget-tip","aria-hidden":"true"},[i])])}function Ur(){const n=new Date,e=Rr(n),t=aa(e.sun.eclipticLongitudeDeg),a=aa(e.moon.eclipticLongitudeDeg),i=Ar(n),o=i?Gr(i):null,r=o?`Sun in ${t.name}. Moon in ${a.name}. Next full moon ${o.spoken}.`:`Sun in ${t.name}. Moon in ${a.name}.`,s=o?m("span",{class:"sky-widget-full"},[m("span",{class:"sky-widget-full-label"},["Full Moon · "]),m("span",{class:"sky-widget-full-when"},[`${o.date} · ${o.time}`])]):m("span",{class:"sky-widget-full"},["Full Moon"]);return m("div",{class:"sky-widget-compact",role:"group","aria-label":r},[ia("sun",`${Oa}${Zt}`,t.name,t.glyph),ia("moon",`${Pa}${Zt}`,a.name,a.glyph),s])}function Vr(n){return n==="chapter01"?"memory":n==="chapter02"?"notice":n==="chapter03"?"recognize":n==="chapter04"?"body":"orbit"}function $r(n){const e=di(n);return e?ui(e.title):"Psychical Excursion"}function Kr(n,e){$n(),document.title=$r(e),n.replaceChildren();const t=m("a",{class:"skip-link",href:"#main"},["Skip to content"]),a=Vr(e),i=jr(a),o=Qr(),r=m("header",{class:"app-header guidebook-header"},[m("a",{href:te,class:"brand-link","aria-label":"Psychical Excursion home"},[m("img",{class:"brand-logo brand-logo-light",src:"/brand/pex-logo-primary.svg",alt:"",width:"220",height:"52",decoding:"async"}),m("img",{class:"brand-logo brand-logo-reverse",src:"/brand/pex-logo-primary-reverse.svg",alt:"",width:"220",height:"52",decoding:"async"})]),m("div",{class:"header-tools guidebook-tools"},[Ur(),m("span",{class:"guidebook-tools-rule","aria-hidden":"true"}),o])]),s=m("div",{id:"live-status",class:"visually-hidden","aria-live":"polite"}),l=m("main",{id:"main",class:"main-stage guidebook-main",tabindex:"-1","data-guidebook-page":e}),h=m("footer",{class:"site-footer guidebook-footer"},[m("p",{class:"attribution"},[Ao("Website by "),m("a",{href:"https://hoopsnakedesigns.com/",rel:"noreferrer"},["Hoopsnake Designs"])])]),d=m("div",{class:"app-frame guidebook-frame","data-ambient":a},[r,s,l,h]);return n.append(t,i,d),{main:l}}function Jr(n){Lr(n)}function Qr(){const n=Vn()==="bedtime",e=m("button",{type:"button",id:"theme-light-dark",class:"theme-switch",role:"switch",dir:"ltr","aria-checked":n?"true":"false","aria-label":"Dark appearance"},[m("span",{class:"theme-switch-track","aria-hidden":"true",dir:"ltr"},[m("span",{class:"theme-switch-thumb"})])]);return e.addEventListener("click",()=>{const a=Ua()==="bedtime";e.setAttribute("aria-checked",a?"true":"false")}),e}const Un=[];function Ya(){for(;Un.length;)Un.pop()?.()}function Xr(){return typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Zr(n){Ya();const e=[...n.querySelectorAll(".pex-reveal")];if(e.length===0)return;if(Xr()||typeof IntersectionObserver!="function"){for(const a of e)a.classList.add("is-visible");return}e[0]?.classList.add("is-visible");const t=new IntersectionObserver(a=>{for(const i of a)i.isIntersecting&&(i.target.classList.add("is-visible"),t.unobserve(i.target))},{threshold:.08,rootMargin:"0px 0px -10% 0px"});for(const a of e)t.observe(a);Un.push(()=>t.disconnect())}const oa=[];function es(){for(;oa.length;)oa.pop()?.()}async function ns(n){{if(ga())return;So(),Mr(),es(),Ya();const e=fo(),t=yo(),a=bo(e);a&&!t&&Tn(),wo(e);const{main:i}=Kr(n,e),o={href:te,title:"Introduction",id:"guidebook-prev-home"};if(e==="chapter01"?M(i,ai(),{previous:o,next:{href:ut,title:dt,id:"guidebook-next-chapter-2"}}):e==="chapter02"?M(i,yi(),{previous:{href:ei,title:ha,id:"guidebook-prev-chapter-1"},next:{href:mt,title:Cn,id:"guidebook-next-chapter-3"}}):e==="chapter03"?M(i,vi(),{previous:{href:ut,title:dt,id:"guidebook-prev-chapter-2"},next:{href:gt,title:pt,id:"guidebook-next-chapter-4"}}):e==="chapter04"?M(i,Ii(),{previous:{href:mt,title:Cn,id:"guidebook-prev-chapter-3"},next:We()?{href:ct,title:Dn,id:"guidebook-next-chapter-5"}:void 0}):e==="chapter05"&&We()?M(i,ri(),{previous:{href:gt,title:pt,id:"guidebook-prev-chapter-4"},next:{href:ft,title:yt,id:"guidebook-next-chapter-6"}}):e==="chapter06"?M(i,Si(),{previous:{href:ct,title:Dn,id:"guidebook-prev-chapter-5"},next:{href:wt,title:bt,id:"guidebook-next-chapter-7"}}):e==="chapter07"?M(i,Mi(),{previous:{href:ft,title:yt,id:"guidebook-prev-chapter-6"},next:{href:Tt,title:vt,id:"guidebook-next-chapter-8"}}):e==="chapter08"?M(i,Ni(),{previous:{href:wt,title:bt,id:"guidebook-prev-chapter-7"},next:{href:It,title:kt,id:"guidebook-next-chapter-9"}}):e==="chapter09"?M(i,Li(),{previous:{href:Tt,title:vt,id:"guidebook-prev-chapter-8"},next:{href:At,title:xt,id:"guidebook-next-chapter-10"}}):e==="chapter10"?M(i,Bi(),{previous:{href:It,title:kt,id:"guidebook-prev-chapter-9"},next:{href:Et,title:St,id:"guidebook-next-chapter-11"}}):e==="chapter11"?M(i,zi(),{previous:{href:At,title:xt,id:"guidebook-prev-chapter-10"},next:{href:Mt,title:Rt,id:"guidebook-next-chapter-12"}}):e==="chapter12"?M(i,_i(),{previous:{href:Et,title:St,id:"guidebook-prev-chapter-11"},next:{href:Ct,title:Dt,id:"guidebook-next-chapter-13"}}):e==="chapter13"?M(i,Vi(),{previous:{href:Mt,title:Rt,id:"guidebook-prev-chapter-12"},next:{href:Ot,title:Nt,id:"guidebook-next-chapter-14"}}):e==="chapter14"?M(i,Ji(),{previous:{href:Ct,title:Dt,id:"guidebook-prev-chapter-13"},next:{href:Lt,title:Pt,id:"guidebook-next-chapter-15"}}):e==="chapter15"?M(i,Zi(),{previous:{href:Ot,title:Nt,id:"guidebook-prev-chapter-14"},next:{href:Ft,title:Wt,id:"guidebook-next-chapter-16"}}):e==="chapter16"?M(i,to(),{previous:{href:Lt,title:Pt,id:"guidebook-prev-chapter-15"},next:{href:Yt,title:Bt,id:"guidebook-next-chapter-17"}}):e==="chapter17"?M(i,oo(),{previous:{href:Ft,title:Wt,id:"guidebook-prev-chapter-16"},next:{href:zt,title:Ht,id:"guidebook-next-chapter-18"}}):e==="chapter18"?M(i,lo(),{previous:{href:Yt,title:Bt,id:"guidebook-prev-chapter-17"},next:{href:mo,title:co,id:"guidebook-next-chapter-19"}}):e==="chapter19"?M(i,po(),{previous:{href:zt,title:Ht,id:"guidebook-prev-chapter-18"}}):Wr(i),Zr(i),Jr(n),ko(),t)vo(n,t);else if(a){Tn();const r=navigator.userAgent??"";typeof requestAnimationFrame=="function"&&r.length>0&&!r.includes("jsdom")&&requestAnimationFrame(()=>Tn())}return}}function ts(){const n=document.getElementById("app");if(!n)throw new Error("Missing #app");return n}async function as(){$n(),_a();const n=ts(),e=()=>{ns(n)};if(!ga()){window.addEventListener("popstate",e),window.addEventListener("hashchange",()=>{window.location.hash.startsWith("#/")&&e()}),e();try{await ra.open(),await Ga()}catch{}}}as();
