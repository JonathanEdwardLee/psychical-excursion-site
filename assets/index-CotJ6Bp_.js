...
`,La=`# Remember Your Dreams: Dream Recall Techniques and Research
...
`,st="Notice Your Dreams: Dream Awareness, Patterns and Dream Signs",ao="/dream-awareness-signs/",lt=ao;let an=null;function oo(){return an||(an=Y(to)),an}const ta=`# Recognize the Dream: Lucid Dreaming, Reality Checks and Dream Signs
...
`,En="Recognize the Dream: Lucid Dreaming, Reality Checks and Dream Signs",io="/lucid-dreaming-reality-checks/",ht=io,ro="PEX-IMPLEMENTATION-PLACEHOLDER";let on=null;function so(){const n=ta.trim();return!n||n.includes(ro)?!1:n.startsWith(`# ${En}`)}function lo(){if(!so())throw new Error("Chapter 3 manuscript has not been supplied by PEX_PRIMARY");return on||(on=Y(ta)),on}const ho=`# Feel the Body: Body Scan Meditation and Deep Relaxation
...
`,ct="Feel the Body: Body Scan Meditation and Deep Relaxation",co="/body-scan-meditation/",dt=co;let rn=null;function uo(){return rn||(rn=Y(ho)),rn}const mo=`# Build the Current: Tingling, Energy Sensations and Focused Attention
...
`,ut="Build the Current: Tingling, Energy Sensations and Focused Attention",po="/energy-sensations-meditation/",mt=po;let sn=null;function go(){return sn||(sn=Y(mo)),sn}const yo=`# Quiet the Mind: Meditation Techniques for Sleep and Dream Awareness
...
`,pt="Quiet the Mind: Meditation Techniques for Sleep and Dream Awareness",fo="/meditation-for-lucid-dreaming/",gt=fo;let ln=null;function bo(){return ln||(ln=Y(yo)),ln}const wo=`# See the Image: Visualization, Mental Imagery and Hypnagogic Imagery
...
`,yt="See the Image: Visualization, Mental Imagery and Hypnagogic Imagery",vo="/visualization-hypnagogic-imagery/",ft=vo;let hn=null;function To(){return hn||(hn=Y(wo)),hn}const ko=`# Watch the Edge: Hypnagogia and the Transition Into Lucid Dreaming
...
`,bt="Watch the Edge: Hypnagogia and the Transition Into Lucid Dreaming",Io="/hypnagogia-lucid-dreaming/",wt=Io;let cn=null;function xo(){return cn||(cn=Y(ko)),cn}const Ao=`# Let the Body Sleep: The “Mind Awake, Body Asleep” Route to Lucid Dreaming
...
`,vt="Let the Body Sleep: The “Mind Awake, Body Asleep” Route to Lucid Dreaming",So="/mind-awake-body-asleep/",Tt=So;let dn=null;function Eo(){return dn||(dn=Y(Ao)),dn}const Ro=`# Move Without Moving: Motor Imagery, Dream Movement and Sleep-Onset Practice
...
`,kt="Move Without Moving: Motor Imagery, Dream Movement and Sleep-Onset Practice",Mo="/motor-imagery-lucid-dreaming/",It=Mo;let un=null;function Do(){return un||(un=Y(Ro)),un}const Co=`# Feel the Shift: Vibrations, Floating and Out-of-Body Sensations Near Sleep
...
`,xt="Feel the Shift: Vibrations, Floating and Out-of-Body Sensations Near Sleep",No="/out-of-body-sensations-sleep/",At=No;let mn=null;function Po(){return mn||(mn=Y(Co)),mn}const Oo=`# Know the Threshold: How to Recognize When Waking Imagery Becomes a Dream
...
`,St="Know the Threshold: How to Recognize When Waking Imagery Becomes a Dream",Lo="/entering-a-lucid-dream/",Et=Lo;let pn=null;function Fo(){return pn||(pn=Y(Oo)),pn}const Wo=`# Stabilize the Dream: Lucid Dream Stabilization Techniques and Research
...
`,Rt="Stabilize the Dream: Lucid Dream Stabilization Techniques and Research",Ho="/lucid-dream-stabilization/",Mt=Ho;let gn=null;function Yo(){return gn||(gn=Y(Wo)),gn}const zo=`# Explore the Dream: Lucid Dream Experiments, Dream Control and Research
...
`,sr="An experiment in dreams, consciousness, energy, and out-of-body experience";function lr(n){const e=n.trim(),t=e.match(/^#\s+(.+)\n+/);if(!t)throw new Error("Guidebook manuscript must begin with a top-level heading");const a=t[1].trim(),i=e.slice(t[0].length).split(/\n## /),r=qt(i[0]??""),s=[];let l=[];for(let h=1;h<i.length;h+=1){const d=i[h],c=d.indexOf(`
`),g=(c===-1?d:d.slice(0,c)).trim(),b=c===-1?"":d.slice(c+1);if(g==="References"){l=hr(b);continue}s.push({heading:g,paragraphs:qt(b)})}return{openingHeading:a,openingParagraphs:r,sections:s,references:l}}function qt(n){return n.split(/\n---\n/).flatMap(e=>e.split(/\n\n+/)).map(e=>e.replace(/\n/g," ").trim()).filter(Boolean)}function hr(n){return n.split(/\n+/).map(e=>e.trim()).filter(Boolean)}let vn=null;function cr(){return vn||(vn=lr(rr)),vn}function _t(n){return n.replace(/[.,;:!?)]+$/u,"")}function qe(n,e={}){const{linkCitations:t=!0}=e,a=m("span",{class:"guidebook-rich-text"}),o=t?/(\[[^\]]+\]\((?:pex:[a-z0-9-]+|#\/[^)\s]+)\)|\*\*[^*]+\*\*|\*[^*]+\*|\[\d+\]|https:\/\/\S+|doi:10\.\S+)/gi:/(\[[^\]]+\]\((?:pex:[a-z0-9-]+|#\/[^)\s]+)\)|\*\*[^*]+\*\*|\*[^*]+\*|https:\/\/\S+|doi:10\.\S+)/gi;let i=0;for(const r of n.matchAll(o)){const s=r.index??0;s>i&&a.append(n.slice(i,s));const l=r[0],h=l.match(/^\[([^\]]+)\]\((pex:[a-z0-9-]+|#\/[^)\s]+)\)$/i);if(h){const d=h[1],c=h[2],g=c.toLowerCase().startsWith("pex:")?c.slice(4).toLowerCase():"",b=g?za[g]:void 0,f=b?.href??(c===In||c.endsWith(`#${Gn}`)?In:c),T=m("a",{href:f,class:"guidebook-pex-link","data-pex-link":b?.id??kn}),M=d.match(/^\*\*(.+)\*\*$/);M?T.append(m("strong",{},[M[1]])):T.append(d),a.append(T)}else if(l.startsWith("**"))a.append(m("strong",{},[l.slice(2,-2)]));else if(l.startsWith("*"))a.append(m("em",{},[l.slice(1,-1)]));else if(/^\[\d+\]$/.test(l)&&t){const d=l.slice(1,-1);a.append(m("a",{href:`#ref-${d}`,class:"guidebook-citation"},[l]))}else if(l.toLowerCase().startsWith("doi:10.")){const d=_t(l.slice(4));a.append(m("a",{href:`https://doi.org/${d}`,class:"guidebook-doi",rel:"noreferrer"},[l]))}else if(l.toLowerCase().startsWith("https://")){const d=_t(l);a.append(m("a",{href:d,class:"guidebook-external",rel:"noreferrer"},[l]))}else a.append(l);i=s+l.length}return i<n.length&&a.append(n.slice(i)),a.childNodes.length||a.append(n),a}function Bn(n,e){const t=m("p",{});return t.append(qe(n,e)),t}function xa(n){const e=n.match(/^(?:\*\*)?\[(\d+)\](?:\*\*)?\s*(.*)$/),t=e?.[1]??"0",a=e?.[2]??n,o=m("li",{id:`ref-${t}`,class:"guidebook-reference-item"}),i=m("span",{class:"guidebook-ref-num"},[`[${t}] `]);return o.append(i,qe(a,{linkCitations:!1})),o.tabIndex=-1,o}function dr(n){for(const e of n.querySelectorAll("a.guidebook-citation"))e.addEventListener("click",t=>{const o=(e.getAttribute("href")??"").match(/^#ref-(\d+)$/);if(!o)return;const i=n.querySelector(`#ref-${o[1]}`);if(!i)return;t.preventDefault();const r=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;i.scrollIntoView({behavior:r?"auto":"smooth",block:"start"}),i.focus({preventScroll:!0})});for(const e of n.querySelectorAll("a.guidebook-pex-link"))e.addEventListener("click",t=>{const a=e.getAttribute("href")??"";let o="",i=!0;try{const l=new URL(a,window.location.href);o=l.hash.replace(/^#/,"");const h=window.location.pathname.replace(/\/?$/,"/"),d=l.pathname.replace(/\/?$/,"/");i=d===h||d==="/"||a.startsWith("#")}catch{o=a.includes("#")?a.split("#").pop()??"":""}if(!o||o.startsWith("/")||!i)return;const r=n.querySelector(`[id="${o}"]`);if(!r)return;t.preventDefault(),r.closest(".guidebook-section")?.classList.add("is-visible");const s=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;r.scrollIntoView({behavior:s?"auto":"smooth",block:"start"}),r.focus({preventScroll:!0})})}function Oe(n){return m("section",{class:n?"guidebook-section pex-reveal is-visible":"guidebook-section pex-reveal"})}function ur(n){const e=cr(),t=m("article",{class:"guidebook-article"});let a=Oe(!0);t.append(a),a.append(m("p",{class:"guidebook-subtitle"},[sr]),m("h1",{class:"guidebook-opening-title"},[Ja]),m("p",{class:"guidebook-opening-heading"},[e.openingHeading]),...e.openingParagraphs.map(o=>Bn(o)));for(const o of e.sections){a=Oe(!1),t.append(a),a.append(m("h2",{class:"guidebook-section-title"},[o.heading]));for(const i of o.paragraphs){if(i.startsWith("**")&&i.endsWith("**")){a.append(m("p",{class:"guidebook-emphasis-line"},[i.slice(2,-2)]));continue}a.append(Bn(i))}}if(e.references.length){a=Oe(!1),t.append(a),a.append(m("h2",{class:"guidebook-section-title",id:"references"},["References"]));const o=m("ul",{class:"guidebook-references"});for(const i of e.references)o.append(xa(i));a.append(o)}a=Oe(!1),t.append(a),a.append(m("p",{class:"guidebook-next"},[m("a",{href:Xt,class:"guidebook-next-link",id:"guidebook-next-chapter"},[Qt,m("span",{class:"guidebook-next-arrow","aria-hidden":"true"},[" →"])])])),n.append(t)}const Le={innerSeconds:180,midSeconds:240,outerSeconds:300,breatheSeconds:96},j=500,G=500;function v(n,e={}){const t=document.createElementNS("http://www.w3.org/2000/svg",n);for(const[a,o]of Object.entries(e))t.setAttribute(a,o);return t}function x(n,e){const t=(e-90)*Math.PI/180;return[j+n*Math.cos(t),G+n*Math.sin(t)]}function Aa(n,e,t=0){return Array.from({length:n},(a,o)=>x(e,360/n*o+t).join(",")).join(" ")}function jt(n,e,t,a=0){const o=[];for(let i=0;i<n;i+=1)o.push(x(e,360/n*i+a).join(",")),o.push(x(t,360/n*i+180/n+a).join(","));return o.join(" ")}function Tn(n,e,t,a){return[x(t,n),x((e+t)/2,n-a),x(e,n),x((e+t)/2,n+a)].map(o=>o.join(",")).join(" ")}function mr(n,e,t,a){return[x(t,n),x(e,n-a),x(e,n+a)].map(o=>o.join(",")).join(" ")}function _(n,e,t,a,o){n.append(v("polygon",{class:o,points:Aa(e,t,a)}))}function pr(){return typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function gr(){const n=pr(),e=m("figure",{class:n?"pex-attention-instrument is-static":"pex-attention-instrument"});e.setAttribute("role","img"),e.setAttribute("aria-label","Original Psychical Excursion attention instrument: nested thin-line geometry around a fixed center. Looking toward the center is optional. Seeing no afterimage or mental picture is not required.");const t=v("svg",{viewBox:"0 0 1000 1000",focusable:"false"});t.style.setProperty("--pex-attention-inner",`${Le.innerSeconds}s`),t.style.setProperty("--pex-attention-mid",`${Le.midSeconds}s`),t.style.setProperty("--pex-attention-outer",`${Le.outerSeconds}s`),t.style.setProperty("--pex-attention-breathe",`${Le.breatheSeconds}s`);const a=v("g",{class:"pex-attention-layer pex-attention-beyond"});a.append(v("polygon",{class:"pex-attention-line pex-attention-faintest",points:Aa(36,486,5)})),a.append(v("circle",{class:"pex-attention-line pex-attention-faintest",cx:String(j),cy:String(G),r:"478"}));for(let h=0;h<72;h+=1){const d=h*5,c=x(468,d),g=x(h%6===0?492:484,d);a.append(v("line",{class:"pex-attention-line pex-attention-faintest",x1:c[0].toFixed(2),y1:c[1].toFixed(2),x2:g[0].toFixed(2),y2:g[1].toFixed(2)}))}const o=v("g",{class:"pex-attention-layer pex-attention-spin-outer"});o.append(v("circle",{class:"pex-attention-line pex-attention-strong",cx:String(j),cy:String(G),r:"438"})),o.append(v("circle",{class:"pex-attention-line",cx:String(j),cy:String(G),r:"418"}));for(let h=0;h<144;h+=1){const d=h*2.5,c=h%12===0,g=h%4===0,b=x(c?398:g?406:410,d),f=x(438,d);o.append(v("line",{class:c?"pex-attention-line pex-attention-strong":"pex-attention-line pex-attention-fine",x1:b[0].toFixed(2),y1:b[1].toFixed(2),x2:f[0].toFixed(2),y2:f[1].toFixed(2)}))}for(let h=0;h<8;h+=1){const d=h*45;o.append(v("polygon",{class:"pex-attention-line",points:Tn(d,442,462,3.2)}));const c=x(h%2===0?454:448,d);o.append(v("circle",{class:"pex-attention-fill pex-attention-fine",cx:c[0].toFixed(2),cy:c[1].toFixed(2),r:h%2===0?"2.1":"1.3"}))}for(const h of[18,138,258])o.append(v("path",{class:"pex-attention-line pex-attention-arc",d:yr(394,h,h+84)}));const i=v("g",{class:"pex-attention-layer pex-attention-spin-mid"});for(const h of[372,344,316,288])i.append(v("circle",{class:"pex-attention-line",cx:String(j),cy:String(G),r:String(h)}));_(i,12,372,0,"pex-attention-line pex-attention-soft"),_(i,12,372,15,"pex-attention-line pex-attention-soft");for(let h=0;h<24;h+=1)i.append(v("polygon",{class:"pex-attention-line",points:Tn(h*15,300,368,5.4)}));for(let h=0;h<36;h+=1)i.append(v("polygon",{class:"pex-attention-line pex-attention-fine",points:mr(h*10,248,286,3.6)}));for(let h=0;h<24;h+=1){const d=h*15,c=x(132,d),g=x(h%2===0?368:316,d);i.append(v("line",{class:h%2===0?"pex-attention-line":"pex-attention-line pex-attention-fine",x1:c[0].toFixed(2),y1:c[1].toFixed(2),x2:g[0].toFixed(2),y2:g[1].toFixed(2)}))}const r=v("g",{class:"pex-attention-layer pex-attention-breathe"});_(r,8,236,0,"pex-attention-line pex-attention-strong"),_(r,8,236,22.5,"pex-attention-line"),_(r,6,204,0,"pex-attention-line"),_(r,6,204,30,"pex-attention-line"),_(r,4,176,0,"pex-attention-line pex-attention-soft"),_(r,4,176,45,"pex-attention-line pex-attention-soft"),r.append(v("polygon",{class:"pex-attention-line",points:jt(16,220,148,0)})),r.append(v("polygon",{class:"pex-attention-line pex-attention-fine",points:jt(12,190,126,15)}));for(const h of[168,148,128])r.append(v("circle",{class:"pex-attention-line pex-attention-fine",cx:String(j),cy:String(G),r:String(h)}));const s=v("g",{class:"pex-attention-layer pex-attention-spin-inner"});for(let h=0;h<12;h+=1){const[d,c]=x(34,h*30);s.append(v("circle",{class:"pex-attention-line",cx:d.toFixed(2),cy:c.toFixed(2),r:"34"}))}for(let h=0;h<8;h+=1)s.append(v("polygon",{class:"pex-attention-line pex-attention-fine",points:Tn(h*45+22.5,58,108,8)}));_(s,16,96,0,"pex-attention-line pex-attention-fine"),_(s,8,72,0,"pex-attention-line"),s.append(v("circle",{class:"pex-attention-line",cx:String(j),cy:String(G),r:"54"}));for(let h=0;h<32;h+=1){const d=h*11.25,c=x(46,d),g=x(h%4===0?70:62,d);s.append(v("line",{class:"pex-attention-line pex-attention-fine",x1:c[0].toFixed(2),y1:c[1].toFixed(2),x2:g[0].toFixed(2),y2:g[1].toFixed(2)}))}const l=v("g",{class:"pex-attention-layer pex-attention-center"});return l.append(v("circle",{class:"pex-attention-line pex-attention-strong",cx:String(j),cy:String(G),r:"18"})),l.append(v("circle",{class:"pex-attention-line pex-attention-fine",cx:String(j),cy:String(G),r:"8"})),l.append(v("circle",{class:"pex-attention-fill pex-attention-center-point",cx:String(j),cy:String(G),r:"2.2"})),t.append(a,o,i,r,s,l),e.append(t),e}function yr(n,e,t){const a=x(n,e),o=x(n,t),i=t-e>180?1:0;return`M ${a[0].toFixed(2)} ${a[1].toFixed(2)} A ${n} ${n} 0 ${i} 1 ${o[0].toFixed(2)} ${o[1].toFixed(2)}`}function ue(n){return m("section",{class:n?"guidebook-section pex-reveal is-visible":"guidebook-section pex-reveal"})}function Sa(n,e){for(const t of e){if(t.kind==="emphasis"){n.append(m("p",{class:"guidebook-emphasis-line"},[t.text]));continue}if(t.kind==="quote"){const a=m("blockquote",{class:"guidebook-pull"});a.append(qe(t.text)),n.append(a);continue}if(t.kind==="list"){const a=m(t.ordered?"ol":"ul",{class:"guidebook-steps"});for(const o of t.items){const i=m("li",{});i.append(qe(o)),a.append(i)}n.append(a);continue}if(t.kind==="rule"){n.append(m("hr",{class:"guidebook-rule"}));continue}if(!(t.kind==="heading"||t.kind==="practice"||t.kind==="attention")){if(t.kind==="subheading"){n.append(m("h3",{class:"guidebook-practice-subheading"},[t.text]));continue}n.append(Bn(t.text))}}}function fr(n){const e=m("section",{class:"guidebook-practice-part"});return e.append(m("h2",{class:"guidebook-practice-label"},[n.label])),Sa(e,n.blocks),e}function br(n){return m("nav",{class:"guidebook-prev","aria-label":"Previous reading"},[m("a",{href:n.href,class:"guidebook-prev-link",id:n.id},[m("span",{class:"guidebook-prev-arrow","aria-hidden":"true"},["← "]),n.title])])}function H(n,e,t={}){const a=m("article",{class:"guidebook-article guidebook-chapter"});let o=ue(!0);a.append(o),t.previous&&o.append(br(t.previous)),o.append(m("h1",{class:"guidebook-chapter-title"},[e.title]));for(const i of e.blocks){if(i.kind==="heading"){o=ue(!1),a.append(o);const r=m("h2",{class:"guidebook-section-title"},[i.text]),s=Ya(i.text);s&&(r.id=s,r.tabIndex=-1),o.append(r);continue}if(i.kind==="practice"){o=ue(!1),a.append(o);const r=m("aside",{class:"guidebook-practice","aria-label":"Summary, experiment, and intention"});for(const s of i.parts)r.append(fr(s));o.append(r);continue}if(i.kind==="attention"){o=ue(!1),a.append(o),o.append(gr());continue}Sa(o,[i])}if(e.references.length){o=ue(!1),a.append(o),o.append(m("h2",{class:"guidebook-section-title",id:"references"},["References"]));const i=m("ul",{class:"guidebook-references"});for(const r of e.references)i.append(xa(r));o.append(i)}t.next&&(o=ue(!1),a.append(o),o.append(m("p",{class:"guidebook-next"},[m("a",{href:t.next.href,class:"guidebook-next-link",id:t.next.id},[t.next.title,m("span",{class:"guidebook-next-arrow","aria-hidden":"true"},[" →"])])]))),n.append(a)}function I(n,e){const t=document.createElementNS("http://www.w3.org/2000/svg",n);for(const[a,o]of Object.entries(e))t.setAttribute(a,o);return t}function wr(n){const e=m("div",{class:`pex-ambient pex-ambient-${n}`,"aria-hidden":"true"}),t=I("svg",{viewBox:"0 0 1200 900",focusable:"false"}),a=I("g",{class:"pex-ambient-spin pex-ambient-spin-slow"});a.append(I("circle",{class:"pex-ambient-arc",cx:"620",cy:"430",r:"318"}),I("circle",{class:"pex-ambient-arc pex-ambient-arc-faint",cx:"620",cy:"430",r:"214"}),I("circle",{class:"pex-ambient-point",cx:"938",cy:"430",r:"2.2"}),I("circle",{class:"pex-ambient-point",cx:"406",cy:"238",r:"1.6"}));const o=I("g",{class:"pex-ambient-spin pex-ambient-spin-mid"});o.append(I("ellipse",{class:"pex-ambient-arc",cx:"580",cy:"400",rx:"430",ry:"168"}),I("path",{class:"pex-ambient-arc pex-ambient-arc-partial",d:"M220 520 C 380 220, 820 180, 1040 470"}),I("circle",{class:"pex-ambient-point",cx:"1010",cy:"400",r:"1.8"}));const i=I("g",{class:"pex-ambient-axis"});if(i.append(I("line",{class:"pex-ambient-line",x1:"600",y1:"40",x2:"600",y2:"860"}),I("line",{class:"pex-ambient-line pex-ambient-line-soft",x1:"80",y1:"390",x2:"1120",y2:"510"})),t.append(i,a,o),n==="memory"){const r=I("g",{class:"pex-ambient-memory-forms"});r.append(I("ellipse",{class:"pex-ambient-form pex-ambient-form-a",cx:"430",cy:"360",rx:"92",ry:"48"}),I("ellipse",{class:"pex-ambient-form pex-ambient-form-b",cx:"760",cy:"500",rx:"70",ry:"110"}),I("circle",{class:"pex-ambient-form pex-ambient-form-c",cx:"620",cy:"280",r:"36"})),t.append(r)}if(n==="notice"||n==="recognize"){const r=I("g",{class:"pex-ambient-notice-align"});r.append(I("path",{class:"pex-ambient-arc pex-ambient-align-a",d:"M260 300 C 480 220, 700 240, 940 360"}),I("path",{class:"pex-ambient-arc pex-ambient-align-b",d:"M300 620 C 520 420, 760 380, 980 520"}),I("circle",{class:"pex-ambient-point pex-ambient-align-point",cx:"640",cy:"390",r:"2.4"})),n==="recognize"&&r.append(I("circle",{class:"pex-ambient-form pex-ambient-recognize-ring",cx:"640",cy:"390",r:"5.5"})),t.append(r)}if(n==="body"){const r=I("g",{class:"pex-ambient-body-forms"});r.append(I("ellipse",{class:"pex-ambient-form pex-ambient-form-a",cx:"620",cy:"318",rx:"36",ry:"48"}),I("ellipse",{class:"pex-ambient-form pex-ambient-form-b",cx:"620",cy:"468",rx:"58",ry:"92"}),I("circle",{class:"pex-ambient-point",cx:"620",cy:"390",r:"1.8"})),t.append(r)}return e.append(t),e}const vr=[{name:"Aries",glyph:"♈︎"},{name:"Taurus",glyph:"♉︎"},{name:"Gemini",glyph:"♊︎"},{name:"Cancer",glyph:"♋︎"},{name:"Leo",glyph:"♌︎"},{name:"Virgo",glyph:"♍︎"},{name:"Libra",glyph:"♎︎"},{name:"Scorpio",glyph:"♏︎"},{name:"Sagittarius",glyph:"♐︎"},{name:"Capricorn",glyph:"♑︎"},{name:"Aquarius",glyph:"♒︎"},{name:"Pisces",glyph:"♓︎"}];function Gt(n){const e=(n%360+360)%360;return vr[Math.floor(e/30)%12]}function Tr(n){const e=new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric"}).format(n),t=new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"2-digit"}).format(n),a=new Intl.DateTimeFormat(void 0,{month:"long",day:"numeric",hour:"numeric",minute:"2-digit"}).format(n);return{date:e,time:t,spoken:a}}function Ut(n,e,t,a){const o=n==="sun"?`Sun in ${t}`:`Moon in ${t}`;return m("span",{class:"sky-widget-pair",tabindex:"0",role:"img","aria-label":o,"data-sky-body":n},[m("span",{class:"sky-widget-body","aria-hidden":"true"},[e]),m("span",{class:"sky-widget-sign","aria-hidden":"true"},[a]),m("span",{class:"sky-widget-tip","aria-hidden":"true"},[o])])}function kr(){const n=new Date,e=or(n),t=Gt(e.sun.eclipticLongitudeDeg),a=Gt(e.moon.eclipticLongitudeDeg),o=nr(n),i=o?Tr(o):null,r=i?`Sun in ${t.name}. Moon in ${a.name}. Next full moon ${i.spoken}.`:`Sun in ${t.name}. Moon in ${a.name}.`,s=i?m("span",{class:"sky-widget-full"},[m("span",{class:"sky-widget-full-label"},["Full Moon · "]),m("span",{class:"sky-widget-full-when"},[`${i.date} · ${i.time}`])]):m("span",{class:"sky-widget-full"},["Full Moon"]);return m("div",{class:"sky-widget-compact",role:"group","aria-label":r},[Ut("sun",`${Ta}${Bt}`,t.name,t.glyph),Ut("moon",`${ka}${Bt}`,a.name,a.glyph),s])}function Ir(n){return n==="chapter01"?"memory":n==="chapter02"?"notice":n==="chapter03"?"recognize":n==="chapter04"?"body":"orbit"}function xr(n){const e=Za(n);return e?eo(e.title):"Psychical Excursion"}function Ar(n,e){jn(),document.title=xr(e),n.replaceChildren();const t=m("a",{class:"skip-link",href:"#main"},["Skip to content"]),a=Ir(e),o=wr(a),i=Er(),r=m("header",{class:"app-header guidebook-header"},[m("a",{href:te,class:"brand-link","aria-label":"Psychical Excursion home"},[m("img",{class:"brand-logo brand-logo-light",src:"/brand/pex-logo-primary.svg",alt:"",width:"220",height:"52",decoding:"async"}),m("img",{class:"brand-logo brand-logo-reverse",src:"/brand/pex-logo-primary-reverse.svg",alt:"",width:"220",height:"52",decoding:"async"})]),m("div",{class:"header-tools guidebook-tools"},[kr(),m("span",{class:"guidebook-tools-rule","aria-hidden":"true"}),i])]),s=m("div",{id:"live-status",class:"visually-hidden","aria-live":"polite"}),l=m("main",{id:"main",class:"main-stage guidebook-main",tabindex:"-1","data-guidebook-page":e}),h=m("footer",{class:"site-footer guidebook-footer"},[m("p",{class:"attribution"},[ni("Website by "),m("a",{href:"https://hoopsnakedesigns.com/",rel:"noreferrer"},["Hoopsnake Designs"])])]),d=m("div",{class:"app-frame guidebook-frame","data-ambient":a},[r,s,l,h]);return n.append(t,o,d),{main:l}}function Sr(n){dr(n)}function Er(){const n=_n()==="bedtime",e=m("button",{type:"button",id:"theme-light-dark",class:"theme-switch",role:"switch",dir:"ltr","aria-checked":n?"true":"false","aria-label":"Dark appearance"},[m("span",{class:"theme-switch-track","aria-hidden":"true",dir:"ltr"},[m("span",{class:"theme-switch-thumb"})])]);return e.addEventListener("click",()=>{const a=Oa()==="bedtime";e.setAttribute("aria-checked",a?"true":"false")}),e}const qn=[];function Ea(){for(;qn.length;)qn.pop()?.()}function Rr(){return typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Mr(n){Ea();const e=[...n.querySelectorAll(".pex-reveal")];if(e.length===0)return;if(Rr()||typeof IntersectionObserver!="function"){for(const a of e)a.classList.add("is-visible");return}e[0]?.classList.add("is-visible");const t=new IntersectionObserver(a=>{for(const o of a)o.isIntersecting&&(o.target.classList.add("is-visible"),t.unobserve(o.target))},{threshold:.08,rootMargin:"0px 0px -10% 0px"});for(const a of e)t.observe(a);qn.push(()=>t.disconnect())}const Vt=[];function Dr(){for(;Vt.length;)Vt.pop()?.()}async function Cr(n){{if(aa())return;ti(),ir(),Dr(),Ea();const e=Vo(),t=Uo(),a=$o(e);a&&!t&&fn(),Ko(e);const{main:o}=Ar(n,e),i={href:te,title:"Introduction",id:"guidebook-prev-home"};if(e==="chapter01"?H(o,Ga(),{previous:i,next:{href:lt,title:st,id:"guidebook-next-chapter-2"}}):e==="chapter02"?H(o,oo(),{previous:{href:qa,title:Qt,id:"guidebook-prev-chapter-1"},next:{href:ht,title:En,id:"guidebook-next-chapter-3"}}):e==="chapter03"?H(o,lo(),{previous:{href:lt,title:st,id:"guidebook-prev-chapter-2"},next:{href:dt,title:ct,id:"guidebook-next-chapter-4"}}):e==="chapter04"?H(o,uo(),{previous:{href:ht,title:En,id:"guidebook-prev-chapter-3"},next:Fe()?{href:rt,title:Sn,id:"guidebook-next-chapter-5"}:void 0}):e==="chapter05"&&Fe()?H(o,$a(),{previous:{href:dt,title:ct,id:"guidebook-prev-chapter-4"},next:{href:mt,title:ut,id:"guidebook-next-chapter-6"}}):e==="chapter06"?H(o,go(),{previous:{href:rt,title:Sn,id:"guidebook-prev-chapter-5"},next:{href:gt,title:pt,id:"guidebook-next-chapter-7"}}):e==="chapter07"?H(o,bo(),{previous:{href:mt,title:ut,id:"guidebook-prev-chapter-6"},next:{href:ft,title:yt,id:"guidebook-next-chapter-8"}}):e==="chapter08"?H(o,To(),{previous:{href:gt,title:pt,id:"guidebook-prev-chapter-7"},next:{href:wt,title:bt,id:"guidebook-next-chapter-9"}}):e==="chapter09"?H(o,xo(),{previous:{href:ft,title:yt,id:"guidebook-prev-chapter-8"},next:{href:Tt,title:vt,id:"guidebook-next-chapter-10"}}):e==="chapter10"?H(o,Eo(),{previous:{href:wt,title:bt,id:"guidebook-prev-chapter-9"},next:{href:It,title:kt,id:"guidebook-next-chapter-11"}}):e==="chapter11"?H(o,Do(),{previous:{href:Tt,title:vt,id:"guidebook-prev-chapter-10"},next:{href:At,title:xt,id:"guidebook-next-chapter-12"}}):e==="chapter12"?H(o,Po(),{previous:{href:It,title:kt,id:"guidebook-prev-chapter-11"},next:{href:Et,title:St,id:"guidebook-next-chapter-13"}}):e==="chapter13"?H(o,Fo(),{previous:{href:At,title:xt,id:"guidebook-prev-chapter-12"},next:{href:Mt,title:Rt,id:"guidebook-next-chapter-14"}}):e==="chapter14"?H(o,Yo(),{previous:{href:Et,title:St,id:"guidebook-prev-chapter-13"},next:{href:_o,title:Bo,id:"guidebook-next-chapter-15"}}):e==="chapter15"?H(o,jo(),{previous:{href:Mt,title:Rt,id:"guidebook-prev-chapter-14"}}):ur(o),Mr(o),Sr(n),Xo(),t)Jo(n,t);else if(a){fn();const r=navigator.userAgent??"";typeof requestAnimationFrame=="function"&&r.length>0&&!r.includes("jsdom")&&requestAnimationFrame(()=>fn())}return}}function Nr(){const n=document.getElementById("app");if(!n)throw new Error("Missing #app");return n}async function Pr(){jn(),Na();const n=Nr(),e=()=>{Cr(n)};if(!aa()){window.addEventListener("popstate",e),window.addEventListener("hashchange",()=>{window.location.hash.startsWith("#/")&&e()}),e();try{await $t.open(),await Pa()}catch{}}}Pr();
