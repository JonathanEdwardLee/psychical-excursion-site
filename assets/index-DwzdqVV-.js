...
`,Wn="Recognize the Dream: Lucid Dreaming, Reality Checks and Dream Signs",Pi="/lucid-dreaming-reality-checks/",vt=Pi,Li="PEX-IMPLEMENTATION-PLACEHOLDER";let sn=null;function Wi(){const n=Ma.trim();return!n||n.includes(Li)?!1:n.startsWith(`# ${Wn}`)}function Bi(){if(!Wi())throw new Error("Chapter 3 manuscript has not been supplied by PEX_PRIMARY");return sn||(sn=S(Ma)),sn}const Fi=`# Feel the Body: Body Scan Meditation and Deep Relaxation
