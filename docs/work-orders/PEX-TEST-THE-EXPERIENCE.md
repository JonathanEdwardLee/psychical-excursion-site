# PEx Work Order — Test the Experience: Can Lucid Dreams and Out-of-Body Experiences Be Verified?

## Baseline

Implement from accepted main:

`c3271aa19f1cd2e0b09eee5a115ec9596d0499c2`

That baseline includes **Cross the Threshold: Astral Projection, OBE Techniques and Lucid Dreaming**.
...
Teach the reader how to move from vivid personal experience to testable claims without dismissing the experience or overstating what it proves.

Central teaching:

**A subjective event can be real as an experience without yet establishing an external claim. Verification begins when the claim is specified in advance, the target is hidden, the result is recorded before checking, and alternative explanations are reduced.**

The chapter should make clear that lucid dreaming has already been objectively verified as a state through pre-agreed eye signals and real-time two-way communication during polysomnographically verified REM sleep, while stronger claims such as perception of hidden external targets during OBEs remain much less established.
...
- Canonical title/H1: **Test the Experience: Can Lucid Dreams and Out-of-Body Experiences Be Verified?**
- Canonical path: `/testing-out-of-body-experiences/`.
- No public chapter number.
- Add central catalog entry with unique truthful meta description.
- Sitemap becomes 19 published canonical URLs, no hashes.
- Previous-reading navigation from **Cross the Threshold: Astral Projection, OBE Techniques and Lucid Dreaming** to this page.
- This page previous points to `/astral-projection-obe-techniques/`.
- No next-reading link yet.
- Optional legacy alias: `#/test-the-experience`.
- Render Summary / Experiment / Intention immediately before References.
- Preserve experiment title **Make It Falsifiable** and subheadings **Write the rule first**, **Hide the answer**, **Record before checking**, **Reveal**, **Keep the denominator**, **Repeat**.
- Preserve all five references.
...
- Do not claim AWARE/AWARE II proved or disproved non-local consciousness.
- Do not describe lucid-dream verification as verification of paranormal dream content.
- Do not encourage dangerous or medically risky verification methods.
- Preserve all held-feature boundaries.
- Note but do not independently widen scope to solve the >500 kB JS chunk warning unless a bounded no-risk split falls naturally within existing build architecture. Performance optimization can be a separate measured pass.
...
- sitemap contains 19 canonical HTTPS URLs, no hashes;
- no public chapter number;
- Cross the Threshold next → this page;
- this page previous → Cross the Threshold, no next;
- one Summary/Experiment/Intention component;
- **Make It Falsifiable** plus six experiment subheadings;
- five references;
- no internal “PEx” shorthand;
- no claim that AWARE proved/disproved literal OBE;
- no dangerous verification instruction;
