...
**The Sun has a well-established biological pathway into human circadian timing through light. Lunar effects on human sleep have some positive findings but remain inconsistent and mechanistically unsettled. Solar/geomagnetic-health research is emerging and preliminary outside a few physiological domains. Controlled tests have not established reliable astrological personality prediction from planetary positions. Observe first, separate mechanism from correlation, and keep symbolic meaning distinct from demonstrated physical influence.**
...
- Preserve experiment title **Track the Sky Without Cheating** and subheadings **Record the night first**, **Add the Sun**, **Add the Moon**, **Add solar or geomagnetic conditions only later**, **Add one planetary claim**, **Compare**.
- Preserve all 13 references.
- No new location permission. The existing observational/no-location Sky Clock remains the only sky interface.
- Do not add astrological interpretation to the Sky Clock.
...
- **Track the Sky Without Cheating** plus six experiment subheadings;
...
- Sky Clock remains observational and non-interpretive;
