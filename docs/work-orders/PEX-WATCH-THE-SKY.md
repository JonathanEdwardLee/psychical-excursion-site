# PEx Work Order — Watch the Sky: Sun, Moon, Planets and the Science of Sleep & Dreams

## Baseline

Implement from accepted main:

`8f5fadab2b72e93861d8f3fb215d8a9902674a26`

That baseline includes **Compare the Maps: Lucid Dreaming vs. Astral Projection, OBE and Sleep Paralysis**.

Jonathan approved continuing to the next pass on 2026-09-24 and specifically asked for research into the Sun, Moon, planets, sleep, dreams and related claims.

## Canonical public title and path
...
`/sun-moon-planets-sleep-dreams/`

Do not expose a chapter number publicly.

## Objective

Examine celestial cycles as possible influences, cues, correlations, and interpretive frameworks without flattening them into either “the sky controls us” or “nothing in the sky matters.”

Central teaching:

**The sky can be read at several levels at once. The Sun has a well-established biological pathway into human circadian timing through light. Lunar sleep findings are intriguing but inconsistent. Solar/geomagnetic-health research remains preliminary outside stronger physiological domains. The zodiac in the header is an ancient coordinate tradition layered with later astrological meaning, not a scientific prediction engine. Historical occult systems treated the planets as spiritual spheres and destinations of consciousness; modern neuroscience can explain internally generated spatial worlds and OBE phenomenology, but has not established that awareness literally travels to the physical Moon or another planet. Observe first, enjoy the map, and keep astronomy, symbolism, subjective travel, and external verification distinct.**
...
- Preserve manuscript wording except renderer-required markup/reference normalization that does not change visible meaning.
- Use accepted real-path SEO architecture.
- Canonical title/H1: **Watch the Sky: Sun, Moon, Planets and the Science of Sleep & Dreams**.
- Canonical path: `/sun-moon-planets-sleep-dreams/`.
- No public chapter number.
- Add central catalog entry with unique truthful meta description.
- Sitemap becomes 21 published canonical URLs, no hashes.
- Previous-reading navigation from **Compare the Maps: Lucid Dreaming vs. Astral Projection, OBE and Sleep Paralysis** to this page.
- This page previous points to `/lucid-dreaming-vs-astral-projection/`.
- No next-reading link yet.
- Optional legacy alias: `#/watch-the-sky`.
- Render Summary / Experiment / Intention immediately before References.
- Preserve experiment title **Track the Sky Without Cheating** and subheadings **Record the night first**, **Add the Sun**, **Add the Moon**, **Add solar or geomagnetic conditions only later**, **Add one planetary claim**, **Read the Sky Clock historically**, **Travel somewhere impossible**, **Compare**.
- Preserve all 27 references.
- No new location permission. The existing observational/no-location Sky Clock remains the only sky interface.
- Do not add predictive astrological interpretation to the Sky Clock. The manuscript may explain why its existing tropical-zodiac labels exist historically and what they mean geometrically.
- No interactive chapter-specific instrument required unless it reuses already-local non-location astronomical data without new cost, tracking, or permissions.
- Preserve canonical metadata, sitemap, robots, PWA, honest 404 behavior, D-081 GA4, locked shell, Chapter 5 instrument and Chapter 4 deep link.
- Do not claim lunar sleep effects are settled.
- Do not claim geomagnetic activity is proven to influence dreams or consciousness.
- Do not claim astrology is scientifically validated.
- Do not claim dream/OBE travel to the Moon or planets is established physical travel.
- Do not forbid or ridicule deliberate Moon/planet travel as a lucid-dream/OBE phenomenology experiment; keep experience and external verification separate.
- Do not dismiss symbolic/traditional use as if lack of predictive evidence makes cultural meaning nonexistent.
- Preserve all held-feature boundaries.
- Keep >500 kB JS warning visible as separate performance debt.

## Verification

At minimum prove:
- canonical title/path/catalog metadata;
- direct static route artifact;
- unique title/description/canonical HTML;
- sitemap contains 21 canonical HTTPS URLs, no hashes;
- no public chapter number;
- Compare the Maps next → this page;
- this page previous → Compare the Maps and no next;
- one Summary/Experiment/Intention component;
- **Track the Sky Without Cheating** plus eight experiment subheadings;
- 27 reference anchors;
- no internal “PEx” shorthand;
- no claim that lunar effects are settled;
- no scientific-validation claim for astrology;
- no location permission or location collection introduced;
- Sky Clock remains observational and non-predictive; its existing tropical-zodiac labels may be explained in chapter copy without changing the widget;
- GA4 canonical pathname once;
- prior routes, robots, sitemap, PWA, deep links, release/privacy checks remain green.
...
- route/catalog/sitemap;
- manuscript preservation;
- navigation;
- metadata;
- Sky Clock regression;
- GA4 regression;
- verification;
- unresolved issues.
