# PEx Work Order — Return. Record. Repeat: The Best Bedtime Routine for Lucid Dreaming and Astral Projection

## Baseline

Implement from accepted main:

`ce3d341e971bf56e724bea1784b571bcc77a4895`

That baseline includes **Notice the Coincidence: Synchronicity, Recurring Dreams, Shared Dreams and Pattern Recognition** and the founder title correction **Floating in Space: Sun, Moon, Planets and the Science of Sleep & Dreams**.

Jonathan approved the final pass on 2026-09-24.
...
`/lucid-dreaming-astral-projection-bedtime-routine/`

Do not expose a chapter number publicly.

## Objective

Close the guidebook with one repeatable evidence-informed daily/nightly practice that synthesizes the strongest parts of the entire book.

Central teaching:

**The best practice is not the most complicated one. Protect sleep, improve dream recall, set one prospective-memory intention, use one induction method, relax deeply, notice when internally generated experience becomes autonomous, stabilize before exploring, and record immediately afterward. This routine can increase opportunities for lucid dreaming and OBE-like experiences, but it does not guarantee literal astral separation.**

Evidence hierarchy:
- strongest support: MILD, dream recall, properly timed WBTB, lucid-dream induction research;
- promising: SSILD;
- plausible practice components: relaxation, hypnagogic observation, imagined movement, body-schema loosening, stabilization;
- practitioner/occult components: roll-out, rope, floating, separation language;
- not established: literal astral travel as an independently verified mechanism.
...
- Preserve manuscript wording except renderer-required normalization that does not change visible meaning.
- Use accepted real-path SEO architecture.
- Canonical title/H1: **Return. Record. Repeat: The Best Bedtime Routine for Lucid Dreaming and Astral Projection**.
- Canonical path: `/lucid-dreaming-astral-projection-bedtime-routine/`.
- No public chapter number.
- Add central catalog entry with unique truthful meta description.
- Sitemap becomes 23 published canonical URLs, no hashes.
- Previous-reading navigation from **Notice the Coincidence: Synchronicity, Recurring Dreams, Shared Dreams and Pattern Recognition** to this page.
- This page previous points to `/synchronicity-recurring-shared-dreams/`.
- No next-reading link; this is the final planned section.
- Optional legacy alias: `#/return-record-repeat`.
- Render Summary / Experiment / Intention immediately before References.
- Preserve experiment title **The Thirty-Night Practice** and subheadings **Keep the core stable**, **Record five outcomes**, **Use WBTB selectively**, **Keep one affirmation**, **Keep one inside-state instruction**, **Review weekly**, **End honestly**.
- Preserve all six references.
- Preserve exact core affirmation: **My body sleeps. I remain aware. I recognize the transition and calmly enter.**
- Preserve exact inside-state instruction: **I stay with the experience and explore before I explain.**
- Preserve the compact full routine sequence under **The strongest routine is a loop**.
- Do not claim the routine guarantees lucid dreaming or literal astral projection.
- Do not encourage chronic sleep deprivation, forced sleep paralysis, drugs/supplements, hyperventilation, fasting, pain, or unsafe induction.
- Keep MILD/SSILD as alternatives by default, not stacked automatically.
- Preserve **Floating in Space** title correction and existing canonical URL `/sun-moon-planets-sleep-dreams/`.
- Preserve D-081 GA4, canonical metadata, sitemap, robots, PWA, honest 404 behavior, locked shell, Sky Clock, Chapter 5 instrument, Chapter 4 deep link, and all held-feature boundaries.
- Keep the >500 kB JS warning visible as separate performance debt.
...
- sitemap contains 23 canonical HTTPS URLs, no hashes;
- no public chapter number;
- Notice the Coincidence next → this page;
- this page previous → Notice the Coincidence and no next;
- one Summary/Experiment/Intention component;
- **The Thirty-Night Practice** plus seven experiment subheadings;
- six reference anchors;
- exact core affirmation present;
- exact inside-state instruction present;
- full compact routine sequence present;
- no guarantee of literal astral projection;
- no unsafe induction instruction;
- Floating in Space title remains intact;
...
- navigation;
- title-regression check for Floating in Space;
- affirmation/routine preservation;
- GA4 regression;
- verification;
- unresolved issues.
