# CloudDev Work Order — Chapter 10: Let the Body Sleep.

## Authority and baseline

Founder-approved manuscript. Implement from accepted implementation main:

`400b518c0bc3b412af6ae6cd64530726d4518d2a`
...
Publish **Let the Body Sleep.** as the next guidebook chapter following **Watch the Edge.**

## Required route and navigation

- Route: `#/let-the-body-sleep`
- Chapter 9 **Watch the Edge.** next-reading link becomes **Let the Body Sleep. →**
- Chapter 10 previous-chapter arrow returns to **Watch the Edge.**
- Chapter 10 has no next-reading link yet.
- Where the visible phrase **Relax the body** appears in the Experiment, link it to `#/feel-the-body#nighttime-body-release` without changing visible wording.
...
Begin with **Relax the body** if useful.
...
- Preserve numbered/linkable references.
...
- title, route, hash and parser for Chapter 10;
- Chapter 9 → Chapter 10 next navigation;
- Chapter 10 → Chapter 9 previous navigation;
- no Chapter 11 next link yet;
- one Summary/Experiment/Intention practice component;
- 13 references with stable reference anchors;
- exact **Relax the body** href;
- no internal “PEx” wording in rendered Chapter 10 text;
