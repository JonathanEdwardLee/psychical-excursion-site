# PEx Work Order — Cross the Threshold: Astral Projection, OBE Techniques and Lucid Dreaming

## Baseline

Implement from accepted main:

`fb4bf3989d7d8bb4dabd2cf00d9441861706341a`

That baseline includes **Loosen the Body: Body Ownership, Self-Location and Out-of-Body Experience**.
...
`/astral-projection-obe-techniques/`

Do not expose a chapter number publicly.

## Objective

Publish the next researched guidebook section using the accepted SEO/crawlable-route/sitemap architecture.

Central teaching:

**“Astral projection,” sleep-related OBE, wake-initiated lucid dreaming, and sleep-paralysis transitions overlap in practice, but they are not interchangeable explanations. Use the threshold skills already trained—attention, relaxation, imagined movement, dream recognition, stabilization, and body-schema loosening—to test entry methods without promising literal separation or guaranteed success.**

Evidence hierarchy:
- strongest: lucid-dream induction research;
- moderate: OBE phenomenology / body-self / vestibular research;
- limited: deliberate OBE induction research;
- historical/practitioner: astral-projection-specific procedures such as roll-out, rope, elevator, imagined floating, and separation commands.
...
- Use the accepted real-path SEO architecture.
- Canonical H1/title: **Cross the Threshold: Astral Projection, OBE Techniques and Lucid Dreaming**.
- Canonical path: `/astral-projection-obe-techniques/`.
- No public chapter number.
- Add to central catalog with unique truthful meta description.
- Sitemap becomes 18 published canonical URLs, no hashes.
- Previous-reading navigation from **Loosen the Body: Body Ownership, Self-Location and Out-of-Body Experience** to this page.
- This page previous points to `/out-of-body-experience-body-ownership/`.
- No next-reading link yet.
- Optional legacy compatibility: `#/cross-the-threshold`.
- Render Summary / Experiment / Intention immediately before References.
- Preserve experiment title **Choose One Door** and subheadings **Lucid route**, **Imagined movement route**, **Sleep-edge route**, **MILD / SSILD route**, **Natural sleep-paralysis route**, **Record the crossing**.
- Preserve all eleven references.
- No interactive visual required.
- Preserve canonical metadata, sitemap, robots, honest 404 behavior, PWA, GA4 D-081, Chapter 5 instrument, Chapter 4 deep link, reduced motion and locked shell.
- Do not claim literal astral separation is scientifically established.
- Do not claim all OBEs are merely lucid dreams.
- Do not present rope/roll-out/floating techniques as validated OBE induction methods.
- Do not encourage sleep deprivation, drugs, supplements, forced sleep paralysis, hyperventilation or unsafe induction.
- Keep all held personal-product features held.

## Verification

At minimum prove:
- title/path/catalog metadata;
- direct static route artifact;
- unique title/description/canonical HTML;
- sitemap contains 18 HTTPS canonical URLs, no hashes;
- no public chapter number;
- Loosen the Body next → this page;
- this page previous → Loosen the Body and no next;
- one Summary/Experiment/Intention component;
- **Choose One Door** plus six experiment subheadings;
- 11 reference anchors;
- no internal “PEx” shorthand;
- no literal-separation certainty introduced;
- no unsafe sleep-deprivation instruction introduced;
- GA4 sends the canonical pathname once;
- all legacy routes/deep links, robots, sitemap, PWA and release/privacy checks remain green.
