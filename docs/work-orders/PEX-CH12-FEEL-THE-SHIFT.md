# PEx Chapter 12 Work Order — Feel the Shift.

## Baseline

Implement from accepted main:

`3047682956e6145730e661582aa1f869ab1c7995`

Chapter 11 **Move Without Moving.** is the latest accepted chapter.

Jonathan accepted the Chapter 12 manuscript on 2026-09-24.
...
**Which part of the bodily self shifts first—ownership, self-location, perspective, movement, or the sensory body itself?**

Preserve the accepted researched-nonfiction voice. Keep observation, interpretation, tradition, science, and open questions distinct.
...
- Preserve the accepted manuscript wording except for renderer-required markup and source-reference normalization that do not change visible meaning.
- Use the established chapter source/parser/renderer architecture.
- Add route/hash for Chapter 12 **Feel the Shift.**
- Chapter 11 next-reading must point to Chapter 12.
- Chapter 12 previous navigation must point to Chapter 11.
- Chapter 12 is the newest published chapter, so do not add a Chapter 13 next link yet.
- Render **Summary / Experiment / Intention** in the established reusable practice component immediately before References.
- Preserve the experiment title **Map the Shift** and its six tracked categories.
- Preserve reference anchors using the repository's established reference convention.
- No chapter-specific interactive visual is required.
- Preserve compact founder-locked header, observational Sky Clock, Light/Dark, responsive reading width, whole-section reveals, reduced-motion support, previous arrow, editorial next-reading pattern, Chapter 5 geometric attention instrument, and Chapter 4 deep link `#/feel-the-body#nighttime-body-release`.
...
Cover at minimum:
- Chapter 12 title, route, hash and parser;
- Chapter 11 → Chapter 12 next navigation;
- Chapter 12 → Chapter 11 previous navigation;
- no Chapter 13 next link yet;
