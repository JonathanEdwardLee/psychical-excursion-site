# CloudDev Work Order — Chapter 11: Move Without Moving.

## Authority and baseline

Founder-approved manuscript. Implement from accepted implementation main:

`fd9658cd1145d1b112c083fbf460ab1cb6e86116`
...
Publish **Move Without Moving.** as the next guidebook chapter following **Let the Body Sleep.**

## Required route and navigation

- Route: `#/move-without-moving`
- Chapter 10 **Let the Body Sleep.** next-reading link becomes **Move Without Moving. →**
- Chapter 11 previous-chapter arrow returns to **Let the Body Sleep.**
- Chapter 11 has no next-reading link yet.
...
- Preserve manuscript verbatim except renderer-required markup that does not alter visible wording.
...
- Preserve Experiment subheadings **Part One — Move, Then Remember**, **Part Two — Move the Whole Body Without Moving**, and **Part Three — Stop Directing** inside the practice component.
- Preserve numbered/linkable references.
- Preserve compact header, Sky Clock, typography, reading width, footer, Light/Dark behavior, reveal behavior, accessibility/focus behavior, reduced-motion support, and Chapter 5 attention instrument.
- No new major chapter-specific interactive visual is required.
- Do not reopen held features or add analytics/payments/ads/sign-in/Journal/voice/Drive/Calendar/progress/Days/Astronomy-page/fixed-60-day/new-cost/credentials/unrelated scope.

## Tests

Cover at minimum:
- title, route, hash and parser for Chapter 11;
- Chapter 10 → Chapter 11 next navigation;
- Chapter 11 → Chapter 10 previous navigation;
- no Chapter 12 next link yet;
- one Summary/Experiment/Intention practice component;
- three Experiment subheadings;
- five references with stable anchors;
- no internal “PEx” wording in rendered Chapter 11 text;
- held features absent;
- prior chapter routes/navigation intact.
...
Report implementation PR, branch, head SHA, baseline SHA, changed files, route/navigation, manuscript preservation, practice/reference rendering, exact verification results, and unresolved issues. Do not merge.