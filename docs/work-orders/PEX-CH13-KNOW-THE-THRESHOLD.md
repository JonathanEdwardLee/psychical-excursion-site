# PEx Chapter 13 Work Order — Know the Threshold.

## Baseline

Implement from accepted main:

`84d73ad1fc91707259e550eb5b00247b178caeaa`

Chapter 12 **Feel the Shift.** plus founder-authorized GA4 is the latest accepted source baseline.

Jonathan accepted the Chapter 13 manuscript on 2026-09-24.

## Objective

Publish Chapter 13 **Know the Threshold.** as the next guidebook chapter without changing the locked public shell or widening the authorized analytics scope.

Central teaching:

**The threshold is a convergence of clues, not one subjective signal or sleep-stage diagnosis.**

Preserve researched nonfiction in developed paragraphs. Keep subjective experience, physiological measurement, traditional interpretation, scientific evidence and open questions distinct.
...
- Add route/hash for Chapter 13 **Know the Threshold.**
- Chapter 12 next-reading must point to Chapter 13.
- Chapter 13 previous navigation must point to Chapter 12.
- Chapter 13 is the newest published chapter, so do not add a Chapter 14 next link yet.
- Render **Summary / Experiment / Intention** in the established reusable practice component immediately before References.
- Preserve experiment title **Catch the Crossing** and subheadings **The outside**, **The inside**, **The observer**.
- Preserve all eight references using the established reference convention.
- No chapter-specific interactive visual is required.
- Preserve the compact header, observational Sky Clock, Light/Dark, responsive reading width, whole-section reveals, reduced-motion support, previous arrow, editorial next-reading pattern, Chapter 5 geometric attention instrument, Chapter 4 deep link `#/feel-the-body#nighttime-body-release`, and the D-081 GA4 implementation already accepted on main.
...
- Do not claim a subjective sensation identifies N1, REM, lucid REM, sleep paralysis, OBE, or another physiological/metaphysical state.
...
- Do not widen GA4 beyond the accepted D-081 aggregate public navigation/usefulness scope.

## Verification

Cover at minimum:
- Chapter 13 title, route, hash and parser;
- Chapter 12 → Chapter 13 next navigation;
- Chapter 13 → Chapter 12 previous navigation;
- no Chapter 14 next link yet;
- one Summary/Experiment/Intention practice component;
- **Catch the Crossing** and its three subheadings;
- eight reference anchors;
- no internal “PEx” wording in rendered Chapter 13;
- no subjective-stage diagnostic language introduced by implementation;
- GA4 remains route-aware, deduplicated and privacy-bounded;
