# PEx Chapter 14 Work Order — Stabilize the Dream.

## Baseline

Implement from accepted main:

`e09e05d4a0c0d2b151c2809e31082616ef39bbf1`

Chapter 13 **Know the Threshold.** is the latest accepted chapter.

Jonathan approved continuing into the next pass on 2026-09-24.

## Objective

Publish Chapter 14 **Stabilize the Dream.** as the next guidebook chapter without changing the locked public shell or widening D-081 analytics.

Central teaching:

**Lucidity is not stability, and stability is not control.**

Preserve researched nonfiction in developed paragraphs. Separate established findings, preliminary evidence, practitioner techniques, plausible mechanisms and open questions.
...
- Add route/hash for Chapter 14 **Stabilize the Dream.**
- Chapter 13 next-reading must point to Chapter 14.
- Chapter 14 previous navigation must point to Chapter 13.
- Chapter 14 is the newest published chapter, so do not add a Chapter 15 next link yet.
- Render **Summary / Experiment / Intention** in the established reusable practice component immediately before References.
- Preserve experiment title **Stay in the Scene** and subheadings **Touch**, **Look**, **Move**, **Speak**, **No intervention**.
- Preserve all nine references using the established reference convention.
...
- Keep lucidity, stability and control distinct.
- Do not present spinning, hand-rubbing, touch, visual detail, movement or verbal cues as guaranteed stabilization methods.
- Do not imply that dream control proves metaphysical claims.
...
Cover at minimum:
- Chapter 14 title, route, hash and parser;
- Chapter 13 → Chapter 14 next navigation;
- Chapter 14 → Chapter 13 previous navigation;
- no Chapter 15 next link yet;
- one Summary/Experiment/Intention practice component;
- **Stay in the Scene** plus five experiment subheadings;
- nine reference anchors;
- no internal “PEx” wording in rendered Chapter 14;
- no guaranteed-technique language introduced by implementation;
