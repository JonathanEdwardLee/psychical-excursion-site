# PEx Chapter 16 Work Order — Loosen the Body: Body Ownership, Self-Location and Out-of-Body Experience

## Baseline

Implement from accepted main:

`941ee9168c856f1788d00c024ac7d583650f276e`

This baseline includes the accepted SEO-title / crawlable-route / sitemap migration.
...
`/out-of-body-experience-body-ownership/`

Do not expose a chapter number publicly.

## Objective

Publish the next researched guidebook section while preserving the locked public shell, SEO architecture and D-081 analytics.

Central teaching:

**The felt body is not one indivisible thing. Ownership, self-location, perspective and movement can loosen or reorganize independently. Treat those changes as experiences to observe, not automatic proof that consciousness literally separated from the body.**

Keep these layers distinct:
- phenomenology;
- body-ownership/self-location research;
- vestibular-motor mechanisms;
- sleep-related OBE reports;
- traditional or non-local interpretations;
...
- Preserve the manuscript wording except renderer-required markup/reference normalization that does not change visible meaning.
- Use the accepted real-path SEO architecture.
- Canonical title and H1: **Loosen the Body: Body Ownership, Self-Location and Out-of-Body Experience**.
- Canonical public path: `/out-of-body-experience-body-ownership/`.
- No public chapter number.
- Add the new page to the central guidebook catalog with a unique truthful meta description.
- Add the canonical URL to `sitemap.xml` through the catalog generator; sitemap should then contain 17 published URLs.
- Add previous-reading navigation from **Explore the Dream: Lucid Dream Experiments, Dream Control and Research** to this page.
- Previous link from this page points to `/lucid-dream-experiments/`.
- No next-reading link yet.
- Add legacy compatibility for the internal historical route `#/loosen-the-body` only if useful; canonical remains the real path.
- Render Summary / Experiment / Intention immediately before References.
- Preserve experiment title **Loosen the Map** and subheadings **Ownership**, **Location**, **Perspective**, **Movement**, **Compare the components**.
- Preserve all ten references.
- No chapter-specific interactive visual required.
- Preserve locked header, Sky Clock, Light/Dark, responsive reading width, section reveals, reduced motion, Chapter 5 attention instrument, Chapter 4 deep link, PWA, real static routes, robots/sitemap, honest 404 behavior and D-081 GA4.
- Do not present OBE as proven literal consciousness separation.
- Do not reduce all OBE reports to one settled neurological explanation either.
- Do not reopen held personal tools, ads, payments, outreach, fixed 60-day framing or new recurring cost.

## Verification

At minimum prove:
- canonical title/path/catalog metadata;
- cold static route artifact exists;
- page-specific title/description/canonical metadata in generated HTML;
- sitemap contains 17 canonical URLs and no hashes;
- no public chapter number;
- prior Explore page next-reading points here;
- this page previous points to Explore and has no next page;
- one Summary/Experiment/Intention practice component;
- Loosen the Map plus five subheadings;
- ten references;
- no internal “PEx” shorthand in public manuscript;
- no literal-separation certainty introduced by implementation;
- GA4 records the canonical pathname once and ignores in-page fragments;
- legacy/current routes and deep links remain intact;
- robots/sitemap/PWA/release/privacy tests remain green.
...
- route/catalog/sitemap changes;
- manuscript preservation;
- navigation;
- metadata;
- GA4 regression status;
