# PEx Work Order — Notice the Coincidence: Synchronicity, Recurring Dreams, Shared Dreams and Pattern Recognition

## Baseline

Implement from accepted main:

`8e5621efd6960770e293222781ca8473bd61d214`

That baseline includes **Watch the Sky: Sun, Moon, Planets and the Science of Sleep & Dreams**.

Jonathan approved continuing to the next pass on 2026-09-24.
...
`/synchronicity-recurring-shared-dreams/`

Do not expose a chapter number publicly.

## Objective

Explore coincidence, synchronicity, repeated symbols, recurring dream characters/places, and reports of mutual/shared dreaming without treating algorithms, selective attention, memory, probability, emotional salience, or shared waking context as boring explanations—and without pretending that those explanations settle every anomalous report.

Central teaching:

**When you start looking for a pattern, you will notice more of it. That can happen because attention, memory, probability, and expectation changed. It can also produce experiences that feel personally meaningful. Recurring dream characters and places are common enough to study. Reports of mutual dreams and dream-ESP exist, but the evidence does not establish a shared objective dream world. Record first, compare later, and make the coincidence earn its interpretation.**
...
- Canonical title/H1: **Notice the Coincidence: Synchronicity, Recurring Dreams, Shared Dreams and Pattern Recognition**.
- Canonical path: `/synchronicity-recurring-shared-dreams/`.
- No public chapter number.
- Add central catalog entry with unique truthful meta description.
- Sitemap becomes 22 published canonical URLs, no hashes.
- Previous-reading navigation from **Watch the Sky: Sun, Moon, Planets and the Science of Sleep & Dreams** to this page.
- This page previous points to `/sun-moon-planets-sleep-dreams/`.
- No next-reading link yet.
- Optional legacy alias: `#/notice-the-coincidence`.
- Render Summary / Experiment / Intention immediately before References.
- Preserve experiment title **Make the Coincidence Earn It** and subheadings **Choose a symbol**, **Track recurring characters**, **Map recurring places**, **Try a mutual-dream protocol**, **Compare characters and places**, **Keep the misses**, **Ask what it meant anyway**.
- Preserve all nine references.
- No interactive visual required.
- Do not tell the reader that finding the website proves destiny/synchronicity.
- Do not claim recurring dream places are proven external realms.
- Do not claim mutual/shared dreaming is scientifically established as literal shared space.
- Do not claim dream telepathy is established; preserve positive/negative history and replication uncertainty.
- Do not mock or dismiss subjective meaning.
...
- sitemap contains 22 canonical HTTPS URLs, no hashes;
- no public chapter number;
- Watch the Sky next → this page;
- this page previous → Watch the Sky and no next;
- one Summary/Experiment/Intention component;
- **Make the Coincidence Earn It** plus seven experiment subheadings;
- nine reference anchors;
- no internal “PEx” shorthand;
- no destiny claim tied to finding the site;
- no verified-shared-dream-space claim;
- no established-dream-telepathy claim;
